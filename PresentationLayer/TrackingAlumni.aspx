<%@ Page Title="" Language="C#" MasterPageFile="~/PresentationLayer/MasterPage.master" ValidateRequest="false"
    AutoEventWireup="true" CodeFile="TrackingAlumni.aspx.cs" Inherits="PresentationLayer_TrackingAlumni"
    Theme="BlueTheme" %>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td id="tdFrmHeading" class="formheading">
                                            <asp:Label ID="Label1" CssClass="lblFormHead" runat="server" Text="Alumni Tracking"></asp:Label>
                            ...
                            <table cellspacing="1" cellpadding="1" width="100%" bgcolor="#ffffff" border="0" runat="server" id="tblSearch">
                                <tbody>
                                    ...
                                    <tr class="tr2">
                                        ...
                                        <td style="width: 160px">
                                            <asp:DropDownList ID="list_center" runat="server" CssClass="dropdownlist" OnSelectedIndexChanged="list_center_SelectedIndexChanged" AutoPostBack="True">
                                            </asp:DropDownList>
                                        ...
                                        <td style="width: 160px; height: 25px">
                                            ...
                                            <asp:DropDownList ID="list_class" runat="server" CssClass="dropdownlist" AutoPostBack="True" Visible="false"
                                    ...
                                    <tr class="tr2">
                                        <td height="25"></td>
                                        <td class="TextLabel">Counselor :
                                        </td>
                                        <td style="width: 160px">
                                            <asp:DropDownList ID="list_counselors" runat="server" CssClass="dropdownlist">
                                            </asp:DropDownList>
                                            <asp:DropDownList ID="list_teacher" runat="server" CssClass="dropdownlist" Visible="false">
                                            </asp:DropDownList>
                        ...
                        <td colspan="7">&nbsp;
                            <asp:GridView ID="dg_student" runat="server" DataKeyNames="student_id" CssClass="datatable table table-striped table-bordered table-hover"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="Counselor_Name" HeaderText="Counselor">
                                        <%--6--%>
                                        <HeaderStyle HorizontalAlign="Center" Font-Size="14px" />
                                        <ItemStyle HorizontalAlign="Center" Font-Size="14px" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="Student_Status" HeaderText="Placement Status">
                                        <%--7--%>
                                        <HeaderStyle HorizontalAlign="Center" Font-Size="14px" />
                                        <ItemStyle HorizontalAlign="Center" Font-Size="14px" />
                                    </asp:BoundField>
