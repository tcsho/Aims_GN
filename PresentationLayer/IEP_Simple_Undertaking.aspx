<%@ Page Language="C#" MasterPageFile="~/PresentationLayer/MasterPage.master" AutoEventWireup="true" CodeFile="IEP_Simple_Undertaking.aspx.cs" Inherits="PresentationLayer_TCS_IEP_Simple_Undertaking" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    window.onload = function () {
        ...
        window.addEventListener('beforeprint', function () {
         ...
         <asp:Label ID="Label1" CssClass="lblFormHead" runat="server" Text="Bifurcation Student" Visible="false"></asp:Label>
...
<%--     <div class="button  btn btn-primary b1 printbtn ">
            ...
            <asp:Button ID="btnSave" runat="server" Visible="false" Text="Print and Send Email" OnClick="btnSave_Click" CssClass="button  btn btn-primary"  OnClientClick="printr(this)"/><!--OnClientClick="printr(this)-->
           <asp:Button ID="btnPrint" runat="server" Text="Print" CssClass="button btn btn-primary" OnClientClick="printPage(); return false;" Visible="true" />
            ...
            <%--<asp:Label ID="lblStudent_Id" runat="server" CssClass="bi_visibility"></asp:Label>--%>
            <asp:Label ID="lblSession_Id" runat="server" CssClass="bi_visibility"></asp:Label><asp:Label ID="lblClass_Id" runat="server" CssClass="bi_visibility"></asp:Label><asp:Label ID="lblfatheremail" runat="server" CssClass="bi_visibility"></asp:Label>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 text-mediaalign">
                      ...
                      <img src="Component_Marks/ReportCard/images/newlogo.png" />
                                ...
                                <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                    <p class="bifirstpra">I, the parent/guardian of  <asp:Textbox ID="txt_Student_Name1" CssClass="bi_label bi_label_student text-center" runat="server" Enabled="false"></asp:Textbox> ,ERP # <asp:Label runat="server" ID="lblStudent_Id" CssClass="bi_label bi_labelsection"></asp:Label>   studying in <asp:Label runat="server" ID="bi_classchange" CssClass="bi_classchange fontsze"></asp:Label>Section <asp:TextBox ID="txt_Student_Section" CssClass="bi_label bi_labelsection" runat="server" Enabled="false"></asp:TextBox>
