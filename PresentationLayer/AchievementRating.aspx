<%@ Page Title="" Language="C#" MasterPageFile="~/PresentationLayer/MasterPage.master"
    AutoEventWireup="true" CodeFile="AchievementRating.aspx.cs" Inherits="PresentationLayer_AchievementRating" %>
            ...
            <table class="main_table" cellspacing="0" cellpadding="0" width="100%" align="center"
                ...
                <tbody>
                    <tr>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td id="tdFrmHeading" class="formheading">
                                            <asp:Label ID="Label1" CssClass="lblFormHead" runat="server" Text="Define Achievement Rating"></asp:Label>
                       ...
                       Font-Bold="False" ValidationGroup="btnNew">Add New Achievement Rating</asp:LinkButton></td>
                                    </td>
                                </tr>
                                <tr style="width: 100%">
                                                ...
                                                <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width: 510px; height: 25px" class="tr1">
                                                            <asp:TextBox ID="txtCritName" runat="server"  Width="359px"></asp:TextBox>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="height: 19px" class="label" align="center" colspan="1">
