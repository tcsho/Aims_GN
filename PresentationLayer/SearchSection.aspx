<%@ Page Title="" Language="C#" MasterPageFile="~/PresentationLayer/MasterPage.master"
    AutoEventWireup="true" CodeFile="SearchSection.aspx.cs" Inherits="PresentationLayer_SearchSection"
    Theme="BlueTheme" %>
                     ...
                     "<'row'<'col-sm-12'tr>>" +
                      ...
                      "<'row'<'col-sm-12'i>><'row'<'col-sm-12'p>>",
                                "columnDefs": [
                                            ...
                                            { orderable: false, targets: [6, 7]} //disable sorting on toggle button
                                        ]
            ...
            <table class="main_table" cellspacing="0" cellpadding="0" width="750" align="center"
                ...
                <tbody>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td id="tdFrmHeading" class="formheading">
                                            <asp:Label ID="Label1" CssClass="lblFormHead" runat="server" Text="Search Sections"></asp:Label>
                            ...
                            <table cellspacing="1" cellpadding="1" width="100%" bgcolor="#ffffff" border="0">
                                <tbody>
                                    ...
                                    <tr class="tr2">
                                        ...
                                        <td style="height: 25px">
                                            <asp:DropDownList ID="list_subject" runat="server" CssClass="dropdownlist" AutoPostBack="True">
                                            </asp:DropDownList>
                                        </td>
                    ...
                    <tr>
                        <td colspan="7">
                            &nbsp;
                            <asp:GridView ID="dg_section" runat="server" Width="100%" OnRowCommand="dg_section_RowCommand"
                            CssClass="datatable table table-striped table-responsive" OnPreRender="dg_section_PreRender"
                                DataKeyNames="Section_Id" PageSize="1000" OnPageIndexChanging="dg_class_PageIndexChanging"
                                Height="100%" AutoGenerateColumns="False" AllowPaging="True" SkinID="GridView">
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="Section_Name" HeaderText="Section Name" Visible="false"><ItemStyle Font-Size="14px" /> </asp:BoundField>
                                    ...
                                    <asp:BoundField DataField="Center_Id" HeaderText="Center Id" HeaderStyle-CssClass="hide"
