<%@ Page Language="C#" MasterPageFile="~/PresentationLayer/MasterPage.master"
    AutoEventWireup="true" CodeFile="Uni_Counselor_Mapping.aspx.cs" Inherits="PresentationLayer_Uni_Counselor_Mapping" %>
        ...
        <ContentTemplate>
            ...
            <div class="form-group">
                <div class="form-group formheading">
                    <asp:Label ID="Label2" CssClass="lblFormHead" runat="server" Text="Counselor(s) Vs Center(s) Mapping"></asp:Label>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <asp:Button ID="btnIssuanceSubmit" CssClass="btn btn-primary pull-right btn-xs" runat="server" Text="Map Center(s) & Counselor(s)" OnClick="btnSubmit_Click"></asp:Button>
                </div>
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 form-group">
                        ...
                        <%--    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <asp:DropDownList runat="server" AutoPostBack="true" ID="dllTerm" CssClass="dropdownlist" Width="218px" >
                                </asp:DropDownList>
                            </div>
                        </div>--%>
                    </div>
                ...
                <div id="ResultIssue" runat="server">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 titlesection">
                        <h3 class="titlesection">Counselor Vs Centers Mapping</h3>
                    </div>
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 " style="margin-top: 30px">
                        <asp:GridView ID="gv_uni_coun" runat="server" AutoGenerateColumns="False" BorderStyle="None"
                            OnRowDeleting="OnRowDeleting" DataKeyNames="Cc_Id"
                            CssClass="datatable table table-striped table-responsive" OnPreRender="gv_uni_coun_PreRender">
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="First_Name" HeaderText="Counselor Name">
                                    <HeaderStyle HorizontalAlign="Center" />
                                    <ItemStyle Font-Size="14px" HorizontalAlign="Left" />
                                </asp:BoundField>
                                ...
                                <asp:TemplateField HeaderText="Action" ItemStyle-Width="200px">
                                    <ItemTemplate>
                                        <asp:Button runat="server" CssClass="btn-sm btn-danger btn-xs" Text="Deactivate" CommandName="Delete" OnRowDataBound="OnRowDataBound" />
                ...
                <ContentTemplate>
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <label>Center Name(s)</label>
                                    <asp:DropDownList ID="ddlcenters" runat="server" AutoPostBack="True" CssClass="form-control"></asp:DropDownList>
                                    <asp:RequiredFieldValidator ID="rfv1" runat="server" ControlToValidate="ddlcenters" InitialValue="select" ErrorMessage="Please select Group " />

                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <label>Counselor Name(s)</label>
                                    <asp:DropDownList ID="ddlcounselor" runat="server" AutoPostBack="True" CssClass="form-control"></asp:DropDownList>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="ddlcounselor" InitialValue="select" ErrorMessage="Please select Group " />
                        ...
                        <div class="modal-footer">
                            ...
                            <asp:Button ID="btnAddMapping" OnClick="AddMapping" CssClass="btn btn-primary" runat="server" />
                        </div>
                    </div>
                </ContentTemplate>
            </asp:UpdatePanel>
