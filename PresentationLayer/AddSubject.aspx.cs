...
public partial class PresentationLayer_AddSubject : System.Web.UI.Page
{
    ...
    protected void but_saveClass_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (k == 1)
            {
                ImpromptuHelper.ShowPrompt("Subject with this Name and Code already exists");                
            }
            else if (k == 3)
            {
            ...
            //else
            //{
            //    //ImpromptuHelper.ShowPromptGeneric("Subject with this code already exists.",1);
