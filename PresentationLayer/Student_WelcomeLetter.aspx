<%@ Page Title="" Language="C#" MasterPageFile="~/PresentationLayer/MasterPage.master"
    AutoEventWireup="true" CodeFile="Student_WelcomeLetter.aspx.cs" Inherits="PresentationLayer_Student_WelcomeLetter"
    Theme="BlueTheme" %>
                        ...
                        <td valign="top" colspan="3">
                            <asp:GridView ID="gvRegStudents" SkinID="GridView" runat="server" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="StudentNameId" HeaderText="Class">
