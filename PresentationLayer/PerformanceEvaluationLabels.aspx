<%@ Page Title="" Language="C#" MasterPageFile="~/PresentationLayer/MasterPage.master"
    AutoEventWireup="true" CodeFile="PerformanceEvaluationLabels.aspx.cs" Inherits="PresentationLayer_PerformanceEvaluationLabels" %>
                                        ...
                                        <tr>
                                            <td>
                                                <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                                    ...
                                                    <tr>
                                                        <td class="tr1" style="width: 8px; height: 21px">
                                                            &nbsp;</td>
                                                        <td align="right" class="tr1" style="width: 350px" valign="top">
                                                            Sort Order in Result Card:</td>
                                                        <td class="tr1" style="width: 510px; height: 25px">
                                                            <asp:TextBox ID="txtSortOrder" runat="server" Width="20px"></asp:TextBox>
                                                        </td>
                                                    </tr>
