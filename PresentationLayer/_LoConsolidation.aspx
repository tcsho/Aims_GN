<%@ Page Title="" Language="C#" MasterPageFile="~/PresentationLayer/MasterPage.master" AutoEventWireup="true" CodeFile="_LoConsolidation.aspx.cs" Inherits="PresentationLayer_LoConsolidation"
    Theme="BlueTheme" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <ContentTemplate>
            ...
            <div class="vh-100">
                ...
                <ul class="nav nav-tabs">
                    ...
                    <li><a data-toggle="tab" href="#menu2">SIQA Endorsed Grades</a></li>
                </ul>
                                            ...
                                            <tr class="row">
                                                <td class="col-lg-2">
                                                    <div class="form-group">
                                                        ...
                                                        <asp:DropDownList
                                                            ID="ddlgrade" CssClass="dropdownlist form-control" runat="server">
                                                            <asp:ListItem Selected="True" Value="" Text="--Select--"></asp:ListItem>
                                                            <asp:ListItem Text="OS" Value="OS"></asp:ListItem>
                                                            <asp:ListItem Text="G" Value="G"></asp:ListItem>
                                                            <asp:ListItem Text="A" Value="A"></asp:ListItem>
                                                ...
                                                <td class="col-lg-2">
                                                    <div class="form-group">
                                                        ...
                                                        <asp:DropDownList Enabled="false"
                                                            ID="ddltechgrade" CssClass="dropdownlist form-control" runat="server">
                                                            <asp:ListItem Selected="True" Value="" Text="--Select--"></asp:ListItem>
                                                            <asp:ListItem Text="OS" Value="OS"></asp:ListItem>
                                                            <asp:ListItem Text="G" Value="G"></asp:ListItem>
                                                            <asp:ListItem Text="A" Value="A"></asp:ListItem>
                                            ...
                                            <tr class="row">
                                                ...
                                                <td class="col-lg-2">
                                                    <div class="form-group">
                                                        <label class="TextLabelLeft">Grade :</label>
                                                        <asp:DropDownList Enabled="false"
                                                            ID="ddgradestudentlearningskills" CssClass="dropdownlist form-control" runat="server">
                                                            <asp:ListItem Selected="True" Value="" Text="--Select--"></asp:ListItem>
                                                            <asp:ListItem Text="OS" Value="OS"></asp:ListItem>
                                                            <asp:ListItem Text="G" Value="G"></asp:ListItem>
                                                            <asp:ListItem Text="A" Value="A"></asp:ListItem>
                                            ...
                                            <tr class="row">
                                                ...
                                                <td class="col-lg-3">
                                                    <div class="form-group">
                                                        <label class="TextLabelLeft">Grade :</label>
                                                        <asp:DropDownList
                                                            ID="ddlgradeattituderelationship" CssClass="dropdownlist form-control" runat="server">
                                                            <asp:ListItem Selected="True" Value="" Text="--Select--"></asp:ListItem>
                                                            <asp:ListItem Text="OS" Value="OS"></asp:ListItem>
                                                            <asp:ListItem Text="G" Value="G"></asp:ListItem>
                                                            <asp:ListItem Text="A" Value="A"></asp:ListItem>
                                    ...
                                    <td>
                                        <table class="main_table col-lg-12" cellspacing="0" cellpadding="0"
                                            ...
                                            <tr class="row">
                                                ...
                                                <td class="col-lg-2">
                                                    <div class="form-group">
                                                        <label class="TextLabelLeft">Settled Well :</label>
                                                        <asp:DropDownList
                                                ...
                                                <tr class="row">
                                                    <td class="col-lg-2">
                                                        <div class="form-group">
                                                            <label class="TextLabelLeft">Grade :</label>
                                                            <asp:DropDownList
                                                                ID="ddlgradecareandclassromroutine" CssClass="dropdownlist form-control" runat="server">
                                                                <asp:ListItem Selected="True" Value="" Text="--Select--"></asp:ListItem>
                                                                <asp:ListItem Text="OS" Value="OS"></asp:ListItem>
                                                                <asp:ListItem Text="G" Value="G"></asp:ListItem>
                                                                <asp:ListItem Text="A" Value="A"></asp:ListItem>
                                ...
                                <tr align="center">
                                    <td style="height: 22px" class="titlesection" colspan="3">
                                        <asp:Label ID="Label7" runat="server" ForeColor="White" Font-Bold="True" Font-Size="11px"
                                            Visible="true" Font-Overline="False" Class="formheading">Overall Progress </asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                            ...
                                            <tr class="row">
                                                <td class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <asp:DropDownList
                                                            ID="ddlstudentprogress" CssClass="dropdownlist form-control" runat="server">
                                                            <asp:ListItem Selected="True" Value="" Text="--Select--"></asp:ListItem>
                                                            <asp:ListItem Text="OS" Value="OS"></asp:ListItem>
                                                            <asp:ListItem Text="G" Value="G"></asp:ListItem>
                                                            <asp:ListItem Text="A" Value="A"></asp:ListItem>
                                                ...
                                                <td class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <asp:DropDownList
                                                            ID="ddloveralllesssongrade" CssClass="dropdownlist form-control" runat="server">
                                                            <asp:ListItem Selected="True" Value="" Text="--Select--"></asp:ListItem>
                                                            <asp:ListItem Text="OS" Value="OS"></asp:ListItem>
                                                            <asp:ListItem Text="G" Value="G"></asp:ListItem>
                                                            <asp:ListItem Text="A" Value="A"></asp:ListItem>
                                ...
                                <asp:GridView ID="gvloconsolidation" runat="server" CssClass="datatable table table-striped table-bordered table-hover "
                                    ...
                                    <Columns>
                                       <%-- <asp:TemplateField ItemStyle-Width="10px" HeaderStyle-Width="10px">
                                        ...
                                        <asp:BoundField DataField="Document_Date" HeaderText="Date">
                                            <ItemStyle HorizontalAlign="Left" />
                                        ...
                                        <asp:TemplateField HeaderText="Need Ability Group Grade Final">
                                            ...
                                            <ItemTemplate>
                                                <asp:DropDownList ID="gvDdlOverallNeed_Ability_Group_Grade_Final" runat="server"
                                                    SelectedValue='<%# Bind("Need_Ability_Group_Grade_Final") %>' CssClass="dropdownlist">
                                                    <asp:ListItem Text="--Select--" Value=""></asp:ListItem>
                                                    <asp:ListItem Text="OS" Value="OS"></asp:ListItem>
                                                    <asp:ListItem Text="G" Value="G"></asp:ListItem>
                                                    <asp:ListItem Text="A" Value="A"></asp:ListItem>
                                        ...
                                        <asp:TemplateField HeaderText="Teaching Grade Final">
                                            ...
                                            <ItemTemplate>
                                                <asp:DropDownList ID="gvDdlOverallTeaching_Grade_Final" runat="server"
                                                    SelectedValue='<%# Bind("Teaching_Grade_Final") %>' CssClass="dropdownlist">
                                                    <asp:ListItem Text="--Select--" Value=""></asp:ListItem>
                                                    <asp:ListItem Text="OS" Value="OS"></asp:ListItem>
                                                    <asp:ListItem Text="G" Value="G"></asp:ListItem>
                                                    <asp:ListItem Text="A" Value="A"></asp:ListItem>
                                        ...
                                        <asp:TemplateField HeaderText="Student Learning Skills Grade Final">
                                            ...
                                            <ItemTemplate>
                                                <asp:DropDownList ID="gvDdlOverallStudent_Learning_Skills_Grade_Final" runat="server"
                                                    SelectedValue='<%# Bind("Student_Learning_Skills_Grade_Final") %>' CssClass="dropdownlist">
                                                    <asp:ListItem Text="--Select--" Value=""></asp:ListItem>
                                                    <asp:ListItem Text="OS" Value="OS"></asp:ListItem>
                                                    <asp:ListItem Text="G" Value="G"></asp:ListItem>
                                                    <asp:ListItem Text="A" Value="A"></asp:ListItem>
                                        ...
                                        <asp:TemplateField HeaderText="Attitudes Relationships Grade Final">
                                            ...
                                            <ItemTemplate>
                                                <asp:DropDownList ID="gvDdlOverallAttitudes_Relationships_Grade_Final" runat="server"
                                                    SelectedValue='<%# Bind("Attitudes_Relationships_Grade_Final") %>' CssClass="dropdownlist">
                                                    <asp:ListItem Text="--Select--" Value=""></asp:ListItem>
                                                    <asp:ListItem Text="OS" Value="OS"></asp:ListItem>
                                                    <asp:ListItem Text="G" Value="G"></asp:ListItem>
                                                    <asp:ListItem Text="A" Value="A"></asp:ListItem>
                                        ...
                                        <asp:TemplateField HeaderText="Care And Classroom Routines Grade Final">
                                            ...
                                            <ItemTemplate>
                                                <asp:DropDownList ID="gvDdlOverallCare_And_Classroom_Routines_Grade_Final" runat="server"
                                                    SelectedValue='<%# Bind("Care_And_Classroom_Routines_Grade_Final") %>' CssClass="dropdownlist">
                                                    <asp:ListItem Text="--Select--" Value=""></asp:ListItem>
                                                    <asp:ListItem Text="OS" Value="OS"></asp:ListItem>
                                                    <asp:ListItem Text="G" Value="G"></asp:ListItem>
                                                    <asp:ListItem Text="A" Value="A"></asp:ListItem>
                                        ...
                                        <asp:TemplateField HeaderText="Student Progress Grade Final">
                                            ...
                                            <ItemTemplate>
                                                <asp:DropDownList ID="gvDdlOverallStudent_Progress_Grade_Final" runat="server"
                                                    SelectedValue='<%# Bind("Student_Progress_Grade_Final") %>' CssClass="dropdownlist">
                                                    <asp:ListItem Text="--Select--" Value=""></asp:ListItem>
                                                    <asp:ListItem Text="OS" Value="OS"></asp:ListItem>
                                                    <asp:ListItem Text="G" Value="G"></asp:ListItem>
                                                    <asp:ListItem Text="A" Value="A"></asp:ListItem>
                                        ...
                                        <asp:TemplateField HeaderText="Lesson Planning Grade Final">
                                            ...
                                            <ItemTemplate>
                                                <asp:DropDownList ID="gvDdlOverallLesson_Planning_Grade_Final" runat="server"
                                                    SelectedValue='<%# Bind("Lesson_Planning_Grade_Final") %>' CssClass="dropdownlist">
                                                    <asp:ListItem Text="--Select--" Value=""></asp:ListItem>
                                                    <asp:ListItem Text="OS" Value="OS"></asp:ListItem>
                                                    <asp:ListItem Text="G" Value="G"></asp:ListItem>
                                                    <asp:ListItem Text="A" Value="A"></asp:ListItem>
    ...
    <script type="text/javascript">
        ...
        //        console.log("Clicked tab name: " + tabName);
        //    });
        //});
