<%@ Page Title="" Language="C#" MasterPageFile="~/PresentationLayer/MasterPage.master"
    AutoEventWireup="true" CodeFile="UniversityPlacement.aspx.cs" Inherits="PresentationLayer_UniversityPlacement" %>
                ...
                <tr>
                    <td align="right" colspan="7">
                        <asp:Button ID="lnkAdd" runat="server" CausesValidation="False" OnClick="lnkAdd_Click"
                            OnPreRender="UpdatePanel1_PreRender" CssClass="btn btn-primary" Text="Add University"></asp:Button></td>
                </tr>

                <tr>
                    <td colspan="7">&nbsp; &nbsp;&nbsp;
                        <asp:GridView ID="dg_Uni" runat="server" AutoGenerateColumns="False"
                            Height="100%" OnRowCommand="dg_Uni_RowCommand" PageSize="50" Width="100%"
                            SkinID="GridView">
                            <Columns>
                                ...
                                <asp:BoundField DataField="University_Ranking" HeaderText="University Ranking" />
                                <asp:BoundField DataField="University_Location" HeaderText="University Location" />
                                <asp:BoundField DataField="Comments" HeaderText="Comments" />
                                <asp:TemplateField HeaderText="Deactivate Status" HeaderStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                        <%--<asp:CheckBox ID="CheckBox1" runat="server" />--%>
                                        <asp:LinkButton ID="lbtndelete" runat="server" OnClick="lbtndelete_Click" OnClientClick="return confirm('Are you sure?');" CommandArgument='<%#Eval("U_Id") %>'>Deactive</asp:LinkButton>
                                    </ItemTemplate>
                        ...
                        <table cellspacing="1" cellpadding="1" width="100%" bgcolor="#ffffff" border="0">
                            <tbody>
                                <tr class="tr1">
                                    ...
                                    <td align="right" width="21%">University Name* :</td>
                                    <td style="width: 159px">
                                        <asp:TextBox ID="text_University" runat="server" CssClass="textbox" ValidationGroup="name" Width="300px"
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ForeColor="Red" runat="server" ValidationGroup="Subject"
                                            SetFocusOnError="True" ErrorMessage="University name is a required field." Display="Dynamic"
                                            ControlToValidate="text_University"></asp:RequiredFieldValidator>
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ForeColor="Red" runat="server" ValidationGroup="name"
                                            ...
                                            ControlToValidate="text_University"></asp:RequiredFieldValidator></td>
                                    <td width="24%">
                                ...
                                <%--  <tr class="tr2">
                                    ...
                                    <td style="width: 159px">
                                        <asp:TextBox ID="text_UniversityCode" runat="server" CssClass="textbox" ValidationGroup="code"
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ValidationGroup="Subject"
                                            ...
                                            ControlToValidate="text_UniversityCode"></asp:RequiredFieldValidator>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ValidationGroup="code"
                                            SetFocusOnError="True" ErrorMessage="Subject code is a required field." Display="Dynamic"
                                            ControlToValidate="text_UniversityCode"></asp:RequiredFieldValidator></td>
                                    <td width="24%">
                                ...
                                <tr class="tr1">
                                    <td width="2%" height="25"></td>
                                    <td align="right" width="21%">University Ranking :</td>
                                    <td style="width: 159px">
                                        <asp:TextBox ID="txtuniranking" runat="server" CssClass="textbox" ValidationGroup="name" Width="300px"
                                            MaxLength="300"></asp:TextBox>
                                    </td>
                                    <td width="24%"></td>
                                    ...
                                    <tr class="tr1">
                                    <td width="2%" height="25"></td>
                                    <td align="right" width="21%">University Location :</td>
                                    <td style="width: 159px">
                                        <asp:TextBox ID="txtunilocation" runat="server" CssClass="textbox" ValidationGroup="name" Width="300px"
