<%@ Page Title="" Language="C#" MasterPageFile="~/PresentationLayer/MasterPage.master"
    AutoEventWireup="true" CodeFile="SubjectWiseItemHeads.aspx.cs" Inherits="PresentationLayer_SubjectWiseItemHeads" %>
            ...
            <table class="main_table" cellspacing="0" cellpadding="0" width="100%" align="center"
                ...
                <tbody>
                    <tr>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td id="tdFrmHeading" class="formheading">
                                            <asp:Label ID="Label1" CssClass="lblFormHead" runat="server" Text="Create Subject Wise Item Heads"></asp:Label>
                       ...
                       Font-Bold="False" ValidationGroup="btnNew">Add New Item Head</asp:LinkButton></td>
                                    </td>
                                </tr>
                                <tr style="width: 100%">
                                ...
                                <tr style="width: 100%">
                                    <td align="left" style="width: 100%; text-align: center" colspan="2">
                                        <asp:GridView ID="gvSubjects" runat="server" AutoGenerateColumns="False" BorderStyle="None"
                                            ...
                                            <Columns>
                                                <asp:BoundField DataField="KndItmHd_Id" SortExpression="KndItmHd_Id" 
                                                    HeaderText="KndItmHd_Id">
                                                ...
                                                <asp:TemplateField HeaderText="Edit">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="btnEdit" runat="server" 
                                                            CommandArgument='<%# Eval("KndItmHd_Id") %>' ForeColor="#004999" 
                                            ...
                                            <td>
                                                <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width: 350px; height: 21px;" class="tr2" valign="top" align="right">
                                                            
                                                        </td>
                                                        <td style="width: 510px; height: 21px" class="tr2" align="right">
                                                            <asp:LinkButton ID="but_new0" runat="server" CssClass="leftlink" 
                                                                Font-Bold="False" OnClick="but_Check_Availibility" ValidationGroup="btnNew">Check availability</asp:LinkButton>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width: 510px; height: 25px" class="tr2">
                                                            <asp:TextBox ID="txtComments" runat="server" Height="56px" TextMode="MultiLine" 
