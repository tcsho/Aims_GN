...
public partial class PresentationLayer_BifurcationConfirmation_IEP : System.Web.UI.Page
{
    ...
    public void Email(string student_id)
    {
        ...
        if (dt1.Rows.Count > 0)
        {
            ...
            To = ConfigurationManager.AppSettings["Bifurcation_email"].ToString();//"huzaifa.ranta@csn.edu.pk";//lblfatheremail.Text.Trim(); dt1.Rows[0][2].ToString();//
