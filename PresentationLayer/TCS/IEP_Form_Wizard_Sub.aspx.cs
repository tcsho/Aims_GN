...
public partial class PresentationLayer_TCS_IEP_Form_Wizard_Sub : System.Web.UI.Page
{
        ...
        )
    {
        ...
        param[22] = new SqlParameter("@Expected_Graduation_Year", txtExpected_Graduation_Year.Text);// will be Edit
    ...
    public void init()
    {
        try
        {
            ...
            if (ds.Tables[0].Rows[0]["ErpClass"].ToString() == "15" && Session["UserType_Id"].ToString() == "34")
            {
                ...
                lbl.Text = "Individual Education Plan (Page 2 out of 3)";
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                if (dsStdDetail.Tables[0].Rows[0]["erpclass"].ToString() == "15" && Session["UserType_Id"].ToString() == "34")
                {
    ...
    public DataSet exec_SP_Save(string json_Subject_detal, string json_Subject_detal1)
    {
        ...
        DataSet ds = objBase.sqlcmdFetch_DS("SP_IEP_Form_SubjectComment_Save", param);
        ds.Dispose();
        return ds;
    }
