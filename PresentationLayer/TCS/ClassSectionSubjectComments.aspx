<%@ Page Title="" Language="C#" MasterPageFile="~/PresentationLayer/MasterPage.master" AutoEventWireup="true" CodeFile="ClassSectionSubjectComments.aspx.cs" Inherits="PresentationLayer_TCS_ClassSectionSubjectComments"
    Theme="BlueTheme" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        ...
        <ContentTemplate>
                ...
                <tbody>
                                ...
                                <tr class="row">
                                    ...
                                    <td class="col-lg-3 col-md-3 col-xs-12 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <asp:DropDownList ID="list_Term" runat="server" AutoPostBack="True" CssClass="dropdownlist form-control list_Term"
                    ...
                    <tr>
                        <td valign="top" colspan="3">
                            <asp:GridView ID="gvRegStudents" SkinID="GridView" DataKeyNames="GoodOne" runat="server" AutoGenerateColumns="False"
                                                    ...
                                                    <td align="left" valign="top" style="word-wrap: break-word" class="studentgrid">
                                                        <table class="col-lg-12 col-md-12 col-xs-12 col-sm-12" cellspacing="0" cellpadding="0">
                                                            ...
                                                            <tr class="row" id="trsubcomments" runat="server">
                                                                ...
                                                                <td>
                                                                    <div runat="server" id="dv1" >
                                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" runat="server" visible='<%# Eval("GoodOne").ToString()== "1" ? true : false%>'>
                                                                        ...
                                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                            ...
                                                                            <p class="gridtxt">
                                                                                <asp:Label runat="server" ID="pleasetxtengtest">Strengths </asp:Label><%--<%# Eval("fullname")%>’s--%>
                                                                            </p>
                                                                        ...
                                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                            <p class="gridtxt">
                                                                                <asp:Label runat="server" ID="improtxt1">
                                                                    ...
                                                                    <div runat="server" id="dv2" >
                                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                            <h3 id="H1" runat="server" class="gridchildheading">Subject Teacher's Comments: </h3>
                                                                        </div>
                                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                            <asp:Panel ID="Panel2" CssClass="col-lg-5 col-md-5 col-xs-12 col-sm-12 nopadding" runat="server">
                                                                                <asp:TextBox runat="server" CssClass="textbox" ID="txtcomments" Text='<%#Bind("Remarks") %>' Font-Bold="false" Font-Size="12" TextMode="MultiLine" Width="400px" Height="150px" ReadOnly="true"> </asp:TextBox>
                                                                            </asp:Panel>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                            ...
                                                            <tr class="row" runat="server">
                                                                ...
                                                                <td>
                                                                    <h3 id="Strong3" runat="server" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 gridchildheading" visible="false">Absent from classes:</h3>
                                                                    <div class="col-lg-6 col-md-6 col-xs-12 col-sm-12">

                                                                        <asp:CheckBox ID="chkAbsent" Text="Absent from classes" AutoPostBack="true" runat="server" Visible="false" OnCheckedChanged="chkAbsent_OnCheckedChanged" CssClass="absent_checkbox" />
                                                                    </div>
                                                                    <div class="col-lg-6 col-md-6 col-xs-12 col-sm-12">
                                                                        <asp:Panel ID="absentdiv" runat="server" CssClass="absentdiv">

                                                                            <asp:Label ID="lblabsenttxt" ForeColor="Red" runat="server" CssClass="lbltxtabsent" Visible="false"></asp:Label>
                                                                            <asp:Label ID="lblAbsent" ForeColor="Red" runat="server" Visible="false"></asp:Label>
                                                                        </asp:Panel>
                                                                    </div>
                                                                </td>
            ...
            <div id="savearea" runat="server" class="savearea">
                ...
                <asp:Button ID="btn_save" runat="server" CssClass="btn btn-primary savebtn" OnClick="btnSave_Click" Text="Saveeeee" ValidationGroup="valSave" />
