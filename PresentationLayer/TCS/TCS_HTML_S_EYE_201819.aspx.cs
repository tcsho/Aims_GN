...
public partial class PresentationLayer_TCS_TCS_HTML_S_EYE_201718 : System.Web.UI.Page
{
                ...
                for (int i = 1; i <= DistinctSubjects.Rows.Count; i++)
                {
                    ...
                    if (class_id == 2) //Class Playgroup
                    {
                        ...
                        if (i < 5)
                        {
                            ...
                            if (divControl != null)
                            {
                                divControl.Style.Add(HtmlTextWriterStyle.PaddingTop, "350px");
                            }
                    ...
                    else if (class_id == 4) //Class Kindergarten
                    {
                        if (i < 5)
                        {
                            ...
                            if (divControl != null)
                            {
                                divControl.Style.Add(HtmlTextWriterStyle.PaddingTop, "325px");
                            }
                        }
                        else
                        {
                        ...
                        if (divControl1 != null)
                        {
                            divControl1.Style.Add(HtmlTextWriterStyle.PaddingTop, "500px");
                        }
                    }
    ...
    private void UrduSubjectSettings(RepeaterItemEventArgs e)
    {
            ...
            (item.ItemType == ListItemType.AlternatingItem))
        {
            ...
            if (ViewState["Subject_Id"].ToString() == "114" || ViewState["Subject_Id"].ToString() == "123" || ViewState["Subject_Id"].ToString() == "12"||
                 ViewState["Subject_Id"].ToString() == "61" || ViewState["Subject_Id"].ToString() == "125")
            {
                ...
                if (GKLO != null)
                {
                    ...
                    GKLO.Style.Add(HtmlTextWriterStyle.Width, "38.5%");
