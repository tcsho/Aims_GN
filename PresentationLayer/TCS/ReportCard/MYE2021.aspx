<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MYE2021.aspx.cs" Inherits="PresentationLayer_TCS_ReportCard_MYE2021" %>
...
<body>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 no-padding">
                    ...
                    <div class="row sec2 article">
                        ...
                        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12 floatleft mediawidth">
                            ...
                            <ul>
                                <li>
                                    <strong>Exam:</strong> Percentage achieved in the end of term examination.
                                </li>
                                <li>
                                    <strong>CA:</strong>
                                    Continuous Assessment marks given during regular classes.
                                </li>
                                <li><strong>Grade:</strong> A*- E or U (Ungraded) is given based on the end of term examination results.</li>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            var Roll_Number = GetUrlParameter('Rno');
            var Session_Id = GetUrlParameter('Sd');
            var Term_Id = GetUrlParameter('Ty');
            var Sec_Id = GetUrlParameter('ScId');
            ...
            $.ajax({
                ...
                success: function (result) {
                            ...
                            if (i < 3) {
                                ...
                                */
                                ...
                                if (result[i].Subject_Id == 17 || result[i].Subject_Id == 12 || result[i].Subject_Id == 133 || result[i].Subject_Id == 18) {
                                    reportcard += '<p class="commentsec1 text-right">' + comments + '</p>';//col-lg-12 col-md-12 col-sm-12 col-xs-12
                                }
                                else {
                                ...
                                if (Session_Id == 12 && Term_Id == 1) {
                                    ...
                                    if (result[i].Class_Id >= 7 && result[i].Class_Id <= 12) /*For Class 3 to Class 8*/ {
                                        ...
                                        if (result[i].Subject_Id == 17 || result[i].Subject_Id == 12 || result[i].Subject_Id == 18) {
                                            if (result[i].isAbsent == true) {
                                                //reportcard += '<p class="commentsec1 col-lg-12 col-md-12 col-sm-12 col-xs-12 ">' + remarks + '</p>';
                                                reportcard += '<p class="commentsec1 text-right">-<span class="maiproblem "><span class="Maintxtwithmain">' + student_nam + '</span></span>' + remarks + '</p>';
                                        ...
                                        reportcard += '<p class="commentsec1 col-lg-12 col-md-12 col-sm-12 col-xs-12 ywala4">' + remarks + '</p>';
                                    }
                                }
                                ...
                                if (i == 3) {
                                    ...
                                    if (result[i].Subject_Id == 17 || result[i].Subject_Id == 12 || result[i].Subject_Id == 133 || result[i].Subject_Id == 18) {
                                        reportcard2 += '<p class="commentsec1 text-right">' + comments + '</p>';//col-lg-12 col-md-12 col-sm-12 col-xs-12
                                    }
                                    else {
                                    ...
                                    if (Session_Id == 12 && Term_Id == 1) {
                                        ...
                                        if (result[i].Class_Id >= 7 && result[i].Class_Id <= 12) /*For Class 3 to Class 8*/ {
                                            ...
                                            if (result[i].Subject_Id == 17 || result[i].Subject_Id == 12 || result[i].Subject_Id == 18) {
                                                ...
                                                if (result[i].isAbsent == true) {
                                                    // reportcard2 += '<p class="commentsec1 col-lg-12 col-md-12 col-sm-12 col-xs-12">' + remarks + '</p>';
                                                    reportcard2 += '<p class="commentsec1 text-right">-<span class="maiproblem"><span class="Maintxtwithmain">' + student_nam + '</span></span>' + remarks + '</p>';
                                                }
                                                else {
                                                    reportcard2 += '<p class="commentsec1 text-right"><span class="maiproblem"><span class="Maintxt">' + student_nam + '</span></span>' + remarks + '</p>';
                                                }
                    ...
                    //        reportcard2 += '<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 ispromoted">Discretionarily promoted</div>';
                    ...
                    if (result[0].Class_Id == 12) {
                        if ((result[0].Region_Name == "(TCS)-Central Region" || result[0].Region_Name == "TPC Central Region") && result[0].isPromoted == false) {




                            reportcard2 += '<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 ispromoted">Bifurcated to Class 9 (Matric)</div>';
