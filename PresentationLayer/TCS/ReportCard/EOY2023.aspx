<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EOY2023.aspx.cs" Inherits="PresentationLayer_TCS_ReportCard_EOY2023" %>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 sec1 article">
                        <div class="row rowdisplayflex headerwithlogo margintoponlogo">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 text-mediaalign">
                                <h4 class="uppertxtinnewreportmargin"><span class="termname"></span> Report Card <span class="yearname"></span></h4>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 text-mediaalignright schoollogoNew">
                                <img id="schoolLogo" src="newlogonewr.png" />
                            </div>
                        </div>
        ...
        $(document).ready(function () {
            ...
            $('.container').off('scroll touchmove mousewheel');
                ...
                $.ajax({
                    ...
                    //data: { querytype:"1"},
                    ////url: 'http://tcsresults.csn.edu.pk/api/Setup/GerReportCard',
                    ////url: 'http://staging.csn.edu.pk:8030/api/Setup/GerReportCard',
                    ////url: 'http://localhost:52673/api/Setup/GerReportCard',
                    //url:"EOY2023.aspx/test",
                    url: "EOY2023.aspx/test",
                   // data: "{querytype: '1'}",
                   data: "{ Session_Id:"+Session_Id+", TermGroup_Id :"+ Term_Id+", Section_Id:"+ Sec_Id+", Student_Id: "+Roll_Number+" }",
                    type: "POST",
                    ...
                    success: function (result) {
                        ...
                        if (result.length == 0) {
                            ...
                            $(".firstthreetable").append(reportcard);
                            return;
                        }
                            ...
                            for (var i = 0; i < result.length; i++) {
                                ...
                                if (i < 3) {
                                    ...
                                    */
                                    ...
                                    if ((Session > 16 && (Term_Id == 1 || Term_Id == 2)) || (Session == 16 && Term_Id == 2)) {
                                        reportcard += '<td class="text-center">Exam</td>';
                                    }
                                    else if ((Session < 16) || (Session == 16 && Term_Id == 1)) {
                                    ...
                                    if (attendenceperc < 25) {
                                        attendence = "Low";
                                        $("#belowEffort").text("Due to student's low attendance, we are unable to comment on any progress made through this term.");
                                    }
                                    else {
                                        attendence = result[0].DaysPresent;
                                        $("#belowEffort").text("Student's strengths and areas for improvement are mentioned below each subject.");
                                    }
                                    ...
                                    if (attendenceperc > 25) {
                                        if (result[i].Class_Id >= 7 && result[i].Class_Id <= 12) {

                                            if (result[i].Subject_Id == 17 || result[i].Subject_Id == 12 || result[i].Subject_Id == 18 || result[i].Subject_Id == 405) {
                                                ...
                                                if (result[i].isAbsent == true) {
                                                    ...
                                                    reportcard += '<li><span class="urdulisno">.۱</span>' + result[i].Improve1 + '</li>';
                                                    reportcard += '<li><span class="urdulisno">.۲</span>' + result[i].Improve2 + '</li>';
                                                    reportcard += '</ol>';
                                                    reportcard += '</td>';
                                                    reportcard += '<td>';
                                                    reportcard += '<ol class="nostylelist">';
                                                    reportcard += '<li><span class="urdulisno">.۱</span>' + result[i].Strength1 + '</li>';
                                                    reportcard += '<li><span class="urdulisno">.۲</span>' + result[i].Strength2 + '</li>';
                                                    reportcard += '</ol>';
                                                    reportcard += '</td>';
                                                    reportcard += '</tr>';
                                                ...
                                                reportcard += '<td>';
                                                reportcard += '<ol>';
                                                reportcard += '<li>' + result[i].Strength1 + '</li>';
                                                reportcard += '<li>' + result[i].Strength2 + '</li>';
                                                reportcard += '</ol>';
                                                reportcard += '</td>';
                                                reportcard += '<td>';
                                                reportcard += '<ol>';
                                                reportcard += '<li>' + result[i].Improve1 + '</li>';
                                                reportcard += '<li>' + result[i].Improve2 + '</li>';
                                                reportcard += '</ol>';
                                                reportcard += '</td>';
                                                reportcard += '</tr>';
                                        ...
                                        else if ((result[i].Class_Id == 13 || result[i].Class_Id == 14) && result[i].Subject_Id == 133) {
                                            if (result[i].isAbsent == true) {
                                                reportcard += '<div class="commentsec1 row rowdisplayflex secondcommnetbox">';
                                                reportcard += '<table class="table-bordered table text-right">';
                                                reportcard += '<thead>';
                                    ...
                                    if (i == 3) {
                                        ...
                                        if (attendenceperc > 25) {
                                            if (result[i].Class_Id >= 7 && result[i].Class_Id <= 12) {
                                                ...
                                                if (result[i].Subject_Id == 17 || result[i].Subject_Id == 12 || result[i].Subject_Id == 18 || result[i].Subject_Id == 405) {
                                                    ...
                                                    if (result[i].isAbsent == true) {
                                                        reportcard2 += '<div class="commentsec1 row rowdisplayflex  secondcommnetbox">';
                                                        reportcard2 += '<table class="table-bordered table text-right">';
                                                        reportcard2 += '<thead>';
                                                        reportcard2 += '<tr>';
                                                        reportcard2 += '<td class="text-center">قابلِ توجہ موضوعات</td>';
                                                        reportcard2 += '<td class="text-center">مہارات</td>';
                                                        ...
                                                        reportcard2 += '<td>';
                                                        reportcard2 += '<ol class="nostylelist">';
                                                        reportcard2 += '<li><span class="urdulisno">.۱</span>' + result[i].Improve1 + '</li>';
                                                        reportcard2 += '<li><span class="urdulisno">.۲</span>' + result[i].Improve2 + '</li>';
                                                        reportcard2 += '</ol>';
                                                        reportcard2 += '</td>';
                                                        reportcard2 += '<td>';
                                                        reportcard2 += '<ol class="nostylelist">';
                                                        reportcard2 += '<li><span class="urdulisno">.۱</span>' + result[i].Strength1 + '</li>';
                                                        reportcard2 += '<li><span class="urdulisno">.۲</span>' + result[i].Strength2 + '</li>';
                                                        reportcard2 += '</ol>';
                                                        reportcard2 += '</td>';
                                                        reportcard2 += '</tr>';
                                                    ...
                                                    reportcard2 += '<div class="commentsec1 row rowdisplayflex secondcommnetbox">';
                                                    reportcard2 += '<table class="table-bordered table">';
                                                    reportcard2 += '<thead>';
                                                    reportcard2 += '<tr>';
                                                    reportcard2 += '<td class="text-center">Strengths</td>';
                                                    reportcard2 += '<td class="text-center">Areas for Improvement</td>';
                                                    reportcard2 += '</tr>';
                                                    reportcard2 += '</thead>';
                                                    reportcard2 += '<tbody>';
                                                    reportcard2 += '<tr>';
                                                    reportcard2 += '<td>';
                                                    reportcard2 += '<ol>';
                                                    reportcard2 += '<li>' + result[i].Strength1 + '</li>';
                                                    reportcard2 += '<li>' + result[i].Strength2 + '</li>';
                                                    reportcard2 += '</ol>';
                                                    reportcard2 += '</td>';
                                                    reportcard2 += '<td>';
                                                    reportcard2 += '<ol>';
                                                    reportcard2 += '<li>' + result[i].Improve1 + '</li>';
                                                    reportcard2 += '<li>' + result[i].Improve2 + '</li>';
                                                    reportcard2 += '</ol>';
                                                    reportcard2 += '</td>';
                                                    reportcard2 += '</tr>';
                                        ...
                                        if (result[i].Subject_Id == 17 || result[i].Subject_Id == 12 || result[i].Subject_Id == 133 || result[i].Subject_Id == 18 || result[i].Subject_Id == 405) {
                                            reportcard2 += '<p class="commentsec1 text-right col-lg-12 col-md-12 col-sm-12 col-xs-12">' + comments + '</p>';
                                        }
                                        else {
                                            reportcard2 += '<p class="commentsec1 col-lg-12 col-md-12 col-sm-12 col-xs-12">' + comments + '</p>';
                                        ...
                                        if (result[i].Subject_Id == 17 || result[i].Subject_Id == 12 || result[i].Subject_Id == 133 || result[i].Subject_Id == 18 || result[i].Subject_Id == 405) {
                                            reportcard2 += '<p class="commentsec1 text-right col-lg-12 col-md-12 col-sm-12 col-xs-12" style="overflow-wrap: break-word;">' + comments + '</p>';
                                        }
                                        else {
                                            reportcard2 += '<p class="commentsec1 col-lg-12 col-md-12 col-sm-12 col-xs-12">' + comments + '</p>';
                                        }
                        ...
                        if (result[0].isPromoted == false && result[0].Cond_Prom == false) {
                            if ((result[0].Region_Name == "(TCS)-Central Region" || result[0].Region_Name == "(TCS) Northern Region") && result[0].Class_Id == 12) {
                                reportcard2 += '<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 notpromoted9thclass ">Promoted to Senior I</div>';
                            }
                        ...
                        if (result[0].Session_Id >= 17 && result[0].Center_Name == "C053-(TCS) Alpha Campus") {
                            $("#schoolLogo").attr("src", "ALPHAShalimarLogo.png");
                        }
                        else {
                            $("#schoolLogo").attr("src", "newlogonewr.png");
                        }
                    }, complete: function () {
                        /*$('.costgraph').css({
