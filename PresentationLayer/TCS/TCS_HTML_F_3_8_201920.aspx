<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TCS_HTML_F_3_8_201920.aspx.cs"
    Inherits="PresentationLayer_TCS_TCS_HTML_F_3_8_201920" %>
                ...
                <div id="main_header" style="width: 100%;">
                    ...
                    <div id="city_school_title_info" style="float: center">
                        <div id="city-school-name" style="padding-left: 90px; padding-right: 90px;">
                            <center>
                                <img src="../../images/City_02.png" width="253" height="53"></center>
                        </div>
...
<%--                            <td>
                ...
                <p>
                    ...
                    <div style="position: absolute; bottom: 40px; margin-left: 10px;">
                        <div id="Div26" style="margin-left: 70px; padding-top: 140px">

                            <p id="P2222" runat="server" style="padding-left: 25px; bottom: 0; padding-bottom: 55px;"
                ...
                <div id="UnderTaking3_7" runat="server" style="width: 900px; height: 1255px; padding: 10px; ; border: 0px solid blue; display: inline-block; position: relative; margin-top: 45px;"
                ...
                <div id="UnertakingLetterBifurcation" runat="server" style="width: 900px; height: 1295px; ; padding: 10px; border: 0px solid blue; display: inline-block; margin-top: 15px; position: relative;"
