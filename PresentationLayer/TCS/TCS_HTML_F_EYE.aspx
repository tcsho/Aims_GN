<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TCS_HTML_F_EYE.aspx.cs" Inherits="PresentationLayer_TCS_TCS_HTML_F_EYE" %>
...
<head>
   ...
   <style type="text/css" media="print" runat="server">
                    ...
                    <ItemTemplate>
                        ...
                        <tr id="pagebreak" runat="server" >
                            ...
                            <td colspan="4" style="border-bottom-width: 0">
                                <asp:Repeater ID="GenPerKeys" runat="server">
                                    <HeaderTemplate>
 ...
 <asp:Repeater ID="GenPer1" runat="server"  OnItemDataBound="Reptr_Subject1_ItemDataBound" >
                    ...
                    <ItemTemplate>
                        ...
                        <tr id="pagebreak" runat="server" >
                            ...
                            <td colspan="4" style="border-bottom-width: 0">
                                <asp:Repeater ID="GenPerKeys1" runat="server">
                                    <HeaderTemplate>
                                        <table style="width: 100%; height: auto; border-width: 0">
                                    </HeaderTemplate>
                                    <ItemTemplate>
          ...
          <div id="class-teacher-comment" style="margin-left: 10px; ">
                ...
                <p style="padding-top:  0px; bottom: 0;">
