<%@ Page Language="C#" MasterPageFile="~/PresentationLayer/MasterPage.master"
    AutoEventWireup="true" CodeFile="IssuanceDate.aspx.cs" Inherits="PresentationLayer_TCS_IssuanceDate" %>
        ...
        <ContentTemplate>
            ...
            <div class="form-group">
                <div class="form-group formheading">
                    <asp:Label ID="Label2" CssClass="lblFormHead" runat="server" Text="Issuance Date Setup"></asp:Label>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <asp:Button ID="btnIssuanceSubmit" CssClass="btn btn-primary pull-right btn-xs" runat="server" Text="Add Issuance Date" OnClick="btnSubmit_Click"></asp:Button>
                </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 " style="margin-top: 30px">
                        <asp:GridView ID="gv_IssuanceDate" runat="server" AutoGenerateColumns="False" BorderStyle="None"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="DateFrom" HeaderText="From Date" DataFormatString="{0:dd/MM/yyyy}">
                                    <HeaderStyle HorizontalAlign="Center" />
                                    <ItemStyle Font-Size="14px" HorizontalAlign="Center" />
                                </asp:BoundField>
                                <asp:BoundField DataField="DateTo" HeaderText="To Date" DataFormatString="{0:dd/MM/yyyy}">
                                    <HeaderStyle HorizontalAlign="Center" />
                                    <ItemStyle Font-Size="14px" HorizontalAlign="Center" />
                                </asp:BoundField>
                                ...
                                <asp:TemplateField HeaderText="Action" ItemStyle-Width="200px">
                                    <ItemTemplate>
                                        <asp:Button runat="server" CssClass="btn-sm btn-primary btn-xs" CommandArgument='<%#Eval("SCPR_ID") + ";" +Eval("DateFrom")+ ";" +Eval("DateTo") + ";" +Eval("Session_Id")%>' OnClick="btnSubmit_Click" Text="Update" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <label>Session</label>
                                    <asp:DropDownList ID="ddl_Session" runat="server" AutoPostBack="True" CssClass="form-control"> </asp:DropDownList>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Date is required."
                                        ControlToValidate="txtToDate" ForeColor="red" ValidationGroup="test"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                        </div>
