<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TCS_HTML_F_M10.aspx.cs" Inherits="PresentationLayer_TCS_TCS_HTML_F_M10" %>
...
<body style="">
    ...
    <asp:Repeater ID="Reptr_Student" runat="server" OnItemDataBound="Reptr_Student_ItemDataBound">
        <ItemTemplate>
            ...
            <div id="blue_border" style="background-color: white; width: 900px; height: 1300px;
                ...
                <table style="width: 97%; margin-left: 10px;">
                    <tr>
                        <td width="38%" style="padding: 5px; widht: 25%; text-align: left">
                            Overall %
                        </td>
                        <td width="15%">
                            <%#Eval("Overall_P") %>
                        </td>
                        <td width="28%" style="padding: 5px; text-align: left">
                            Overall Grade
                        </td>
                        <td width="10%">
                            <%#Eval("Overall_G") %>
...
--%>
                ...
                <div id="performance-indicators" style="padding-top: 30px; padding-bottom: 10px;
                 ...
                 <table style="width: 97%; margin-left: 10px; border: none">
                  <tr>
                        ...
                        <td width="15%">
                            <center>
                                <strong>A*</strong></center>
                        </td>
                        <td width="29%"  style="text-align:left ; padding-left: 10px;">
                           
                                <strong>40% above but below 50%</strong>
                                
                        </td>
                        <td width="10%">
                            <center>
                                <strong>D</strong></center>
                        </td>
                    </tr>
                     <tr>
                        <td width="38%" style="text-align: left; padding-left: 10px;">
                            <strong>70% above but below 80%</strong>
                        </td>
                        <td width="15%">
                            <center>
                                <strong>A</strong></center>
                        ...
                        <td width="29%" style="text-align:left ; padding-left: 10px;">
                                ...
                                <strong>below 40%to minimum pass marks</strong>
                        </td>
                        <td width="10%">
                            <center>
                                <strong>E</strong></center>
                        </td>
                    </tr>
                     <tr>
                        <td width="38%" style="text-align: left; padding-left: 10px;">
                            <strong>60% above but below 70%</strong>
                        </td>
                        <td width="15%">
                            <center>
                                <strong>B</strong></center>
                        </td>
                        <td width="29%" style="text-align:left ; padding-left: 10px;">
                            
                                <strong>below minimum pass marks</strong>
                        </td>
                        <td width="10%">
                            <center>
                                <strong>F</strong></center>
                        </td>
                    </tr> <tr>
                        <td width="38%" style="text-align: left; padding-left: 10px;">
                            <strong>50% above but below 60%</strong>
                        </td>
                        <td width="15%">
                            <center>
                                <strong>C</strong></center>
                        </td>
                        <td width="29%">
                            <center>
                ...
                <div id="class-teacher-comment" style="margin-left:10px;margin-top:20px;">
                    ...
                    <div style="float:left;width:30%;">
                        <h5>
                            ...
                            <div style="border-width:2px;border-style:solid;border-color:Black;width:75%;margin-left:190px;padding:5px;">
                            <span style="text-decoration: underline;line-height:150%;text-align:justify;">
                        
                            <%#Eval("ClassTeacher_Comments") %></span>                            
                            <strong style="line-height:150%;text-align:Right;padding-left:470px;">Sign:_______________</strong>
                            </div>
</p>
   ...
   <div id="Div2" style="margin-left:70px;padding-top:100px">
                <p style="padding-right:100px">
              <%--  <hr width="150" align="left"> --%>
                  <strong style="text-decoration: overline;line-height:150%;text-align:justify">Head of School</strong>
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

                  <strong style="text-decoration: overline;line-height:150%;text-align:justify">School Stamp</strong>

                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  
                  <strong style="text-decoration: overline;line-height:150%;text-align:justify">Parent / Guardian</strong></p>
               </div>
                <!--//////////////////////////////////////-->
            </div>
