<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TCS_HTML_F_3_8_201617.aspx.cs"
    Inherits="PresentationLayer_TCS_TCS_HTML_F_3_8_201617" %>
...
<body style="">
    ...
    <asp:Repeater ID="Reptr_Student" runat="server" OnItemDataBound="Reptr_Student_ItemDataBound">
        <ItemTemplate>
            ...
            <div id="blue_border" style="width: 900px; height: 1295px; padding: 10px; border: 0px solid blue;
                ...
                <div style="position: absolute; bottom: 40px; margin-left: 10px;">
                    ...
                    <div id="Div26" style="margin-left: 70px; padding-top: 140px">
                        ...
                        <p id="P2" runat="server" style="padding-left: 25px; bottom: 0; padding-bottom: 60px;"
                            visible='<%#(Eval("isPromoted").ToString() == "False" && Eval("Class_Id").ToString()=="12" && Eval("Cond_Prom").ToString().Length < 1)?true:false%>'>
            ...
            <div id="UnertakingLetterBifurcation201718" runat="server" style="width: 900px; height: 1295px; font-family: Century; padding: 10px; border: 0px solid blue; display: inline-block; margin-top: 15px; position: relative;"
