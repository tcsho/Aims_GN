...
public partial class PresentationLayer_IEPForTeacherSubject : System.Web.UI.Page
{
    ...
    private void BindGrid(bool doOverride)
    {
        ...
        try
        {
            ...
            if (list_Term.SelectedIndex > 0 && list_Subject.SelectedIndex > 0)
            {
                ...
                //ds = DALBase.getDataSetBySp("Student_Evaluation_CriteriaBySectionSubjectId", param); New page (Change Procedure name)
                ds = DALBase.getDataSetBySp("Sp_IEP_ForSubjectTeacher", param);
                ...
                for (int c = 0; c < ds.Tables[0].Columns.Count; c++)
                {
                    ...
                    else if (c == 4)
                    {
                        if (ds.Tables[0].Columns.Count == 5)
                        {
                            header = ds.Tables[0].Columns[c].ToString();
                            //PlaceHolder1.Controls.Add(new LiteralControl("<td style='padding: 5px; '>" + header + "</td>"));
                            PlaceHolder1.Controls.Add(new LiteralControl("<td style='padding: 5px; '>IEP</td>"));
                        }
                        else
                        {
                            //header = ds.Tables[0].Columns[c].ToString();
                    ...
                    for (int c = 0; c < ds.Tables[0].Columns.Count; c++)
                    {
                         if (c == 4)
                        {
                            if (ds.Tables[0].Columns.Count == 5)
                            {
                                ...
                                //new Code
                                int sessionID = Convert.ToInt32(Session["Session_Id"].ToString());
                                SqlParameter[] paramRecords = new SqlParameter[3];

                                paramRecords[0] = new SqlParameter("@student_id", ds.Tables[0].Rows[r]["Roll#"].ToString());
                                paramRecords[1] = new SqlParameter("@sessionId", sessionID);
                                paramRecords[2] = new SqlParameter("@termId", list_Term.SelectedItem.Text);
                                DataSet dsrecords = DALBase.getDataSetBySp("sp_iep_MarksCompileCheck", paramRecords);
                                //new Code End


                                if (dsrecords.Tables[0].Rows.Count > 0)
                                {
                                    PlaceHolder1.Controls.Add(new LiteralControl("<td class='" + myClass + "'><a href='/PresentationLayer/tcs/IEP_Form_Wizard_Sub.aspx?s=" + ds.Tables[0].Rows[r][c].ToString() + "'><i class=\"glyphicon glyphicon-edit TextLabelMandatory40  text-success\"></i>\r\n</a></td>"));
                                }
                                else
                                {
                                    PlaceHolder1.Controls.Add(new LiteralControl("<td class='" + myClass + "'><a href='#' onclick=\"alert('Wait for compilations')\";><i class=\"glyphicon glyphicon-edit TextLabelMandatory40  text-success\"></i>\r\n</a></td>"));
                                }
                        ...
                        else if (c > 1)
                        {
                            if (c == 5)
                            {
                                ...
                                if (dsrecords.Tables[0].Rows.Count > 0)
                                {
                                    PlaceHolder1.Controls.Add(new LiteralControl("<td class='" + myClass + "'><a href='/PresentationLayer/tcs/IEP_Form_Wizard_Sub.aspx?s=" + ds.Tables[0].Rows[r]["Roll#"].ToString() + "'><i class=\"glyphicon glyphicon-edit TextLabelMandatory40  text-success\"></i>\r\n</a></td>"));
                                }
                                else
                                {
                                    PlaceHolder1.Controls.Add(new LiteralControl("<td class='" + myClass + "'><a href='#' onclick=\"alert('Wait for compilations')\";><i class=\"glyphicon glyphicon-edit TextLabelMandatory40  text-success\"></i>\r\n</a></td>"));
                                ...
                                //if (List_ClassSection.SelectedValue == "12" || List_ClassSection.SelectedValue == "13" || List_ClassSection.SelectedValue == "14" || List_ClassSection.SelectedValue == "15")
                                //{
                                //    PlaceHolder1.Controls.Add(new LiteralControl("<td class='" + myClass + "'><a href='/PresentationLayer/tcs/IEP_Form.aspx?s=" + ds.Tables[0].Rows[r][c].ToString() + "'><i class=\"glyphicon glyphicon-edit TextLabelMandatory40  text-success\"></i>\r\n</a></td>"));
                                //}
                                //else
                                //{
       ...
       
    {
        ...
        try
        {
           ...
           // int seterror = 0;
            //int correct_error = 0;
           for (int c = 2; c < sssId.GetLength(0) - 1; c++)
            {
            ...
            for (int r = 0; r < studentId.GetLength(0); r++) // for all students
            {
                    ...
                    for (int c = 2; c < sssId.GetLength(0) - 1; c++) // for every Criteria of a Student
                        {
