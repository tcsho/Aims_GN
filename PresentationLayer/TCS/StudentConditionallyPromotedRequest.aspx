<%@ Page Title="" Language="C#" MasterPageFile="~/PresentationLayer/MasterPage.master"
    AutoEventWireup="true" CodeFile="StudentConditionallyPromotedRequest.aspx.cs"
    Inherits="PresentationLayer_StudentConditionallyPromotedRequest" %>
                    ...
                    <tr>
                        <td>
                            <table class="main_table" cellspacing="0" cellpadding="0" width="100%" align="center"
                                ...
                                <tr id="trRegion" runat="server">
                                    ...
                                    <td valign="top" style="width: 50%;">
                                        ...
                                        <asp:Button ID="btnShow" runat="server" visible="false" CssClass="btn btn-warning" OnClick="btnShowSubmitted_Click"
                                            Text="Discretionary Requests"></asp:Button>
                                        <asp:Button ID="Button2" runat="server" visible="false" CssClass="btn btn-success" OnClick="btnProcessed_Click"
                            ...
                            <table class="main_table" cellspacing="0" cellpadding="0" width="100%" align="center"
                                ...
                                <tr style="width: 100%">
                                    <td id="tdSearch" runat="server" class="titlesection" colspan="7" visible="false">&nbsp; Detained Student(s) List
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left" colspan="12">
                                                ...
                                                <asp:TemplateField HeaderText="List of Students ">
                                                    ...
                                                    <ItemTemplate>
                                                        <table cellpadding="0" cellspacing="0" style="table-layout: fixed; height: 92%; width: 100%; vertical-align: top;">
                                                            ...
                                                            <tr id="Tr1" runat="server" class="tr2" visible="false">
                                                                <td style="width: 100%; font-size: medium; font-weight: bold;">
                                                                    <div class="pull-right">
                                                            ...
                                                            <tr id="Tr2" runat="server" class="tr2" visible='<%# (int)( Eval("RD_Approval"))==0  %>'>
                                                                <td style="width: 100%; font-size: medium; font-weight: bold;">
                                                                    <div class="pull-right">
                                                                        <asp:Button ID="btnRevert" runat="server" class="btn btn-success" CommandArgument='<%# Eval("Student_No") %>'
                                                                            OnClick="btnRevert_Click" Text="Revert Request" ToolTip="Send to Request Screen" />
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                            <tr class="tr2">
                                                                <td>
                                                                    <div class="pull-right">
                                                                        ...
                                                                        <asp:Button runat="server" ID="btnViewReport" OnClick="btnViewReport_Click" CssClass="btn btn-info"
                                                                            Text="View Result Card" CommandArgument='<%# Eval("Student_No") %>' />
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                        </table>
