<%@ Page Language="C#" MasterPageFile="~/PresentationLayer/MasterPage.master"
    AutoEventWireup="true" CodeFile="Center_HeadName.aspx.cs" Inherits="PresentationLayer_TCS_Center_HeadName" %>
        ...
        <ContentTemplate>
            ...
            <div class="form-group">
                <div class="form-group formheading">
                    <asp:Label ID="Label2" CssClass="lblFormHead" runat="server" Text="Update Center Head Name"></asp:Label>
                ...
                <div id="ResultIssue" runat="server">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 titlesection">
                        <h3 class="titlesection">Center Head Name List</h3>
                    </div>
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 " style="margin-top: 30px">
                        <asp:GridView ID="gv_CenterHead" runat="server" AutoGenerateColumns="False" BorderStyle="None" 
                            CssClass="datatable table table-striped table-responsive" OnPreRender="gv_CenterHead_PreRender">
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="HeadERP" HeaderText="Head ERP">
                                    <HeaderStyle HorizontalAlign="Center" />
                                    <ItemStyle Font-Size="14px" HorizontalAlign="Center" />
                                </asp:BoundField> 
                                ...
                                <asp:TemplateField HeaderText="Action">
                                    <ItemTemplate>
                                        ...
                                        <asp:Button runat="server" CssClass="btn-sm btn-primary btn-xs" CommandArgument='<%#Eval("Center_Id") + ";" +Eval("Center_Name")+ ";" +Eval("HeadERP") + ";" +Eval("HeadName") %>' OnClick="btnSubmit_Click" Text="Update" />
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <asp:TextBox ID="txtCenter_Id" runat="server" CssClass="form-control" ReadOnly="true"></asp:TextBox>
                                </div>
                                <div class="col-md-12">
                                    <label>Center Name</label>
                                    <asp:TextBox ID="txtCenter_Name" runat="server" CssClass="form-control" ReadOnly="true"></asp:TextBox>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <label>Head ERP No.</label>
                                    <asp:TextBox ID="txtHeadERP" runat="server" CssClass="form-control"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Head ERP is required."
                                        ControlToValidate="txtHeadERP" ForeColor="red" ValidationGroup="test"></asp:RequiredFieldValidator>
                                </div>
                                <div class="col-md-6">
                                    <label>Head ERP Name</label>
                                    <asp:TextBox ID="txtHeadName" runat="server" CssClass="form-control"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="Head Name is required."
                                        ControlToValidate="txtHeadName" ForeColor="red" ValidationGroup="test"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button class="btn btn-info pull-left" data-dismiss="modal" aria-hidden="true">Close</button>
                            <asp:Button ID="btnCenterHead" OnClick="UpdateCenterHead" CssClass="btn btn-primary" runat="server" />
                        </div>
                    </div>
                </ContentTemplate>
            </asp:UpdatePanel>
