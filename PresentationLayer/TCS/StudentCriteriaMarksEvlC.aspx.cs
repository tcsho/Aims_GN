...
public partial class PresentationLayer_StudentCriteriaMarksEvlC : System.Web.UI.Page
{
    ...
    private void BindGrid(bool doOverride)
    {
        ...
        try
        {
            ...
            if (list_Term.SelectedIndex > 0 && list_Subject.SelectedIndex > 0 && list_EvlType.SelectedIndex > 0 && list_EvlCriteria.SelectedIndex > 0)
            {
                ...
                DataSet lockMarkDs = DALBase.getDataSetBySp("Student_Evaluation_CriteriaEVlCriteriaBySectSubjIdMarksLock", param);
    ...
    private void BindEvaluationType()
    {
        ...
        {
            BLLSection_Subject obj = new BLLSection_Subject();
            DataTable dt = obj.Evaluation_TypeSelect(Convert.ToInt32(Session["moID"].ToString()));
    ...
    private void BindEvaluationCriteria()
    {
        ...
        if (List_ClassSection.SelectedIndex > 0)
        {
            ...
            obj.Section_Subject_Id = Convert.ToInt32(list_Subject.SelectedValue.ToString());
            obj.Evaluation_Type_Id = Convert.ToInt32(list_EvlType.SelectedValue.ToString());
            DataTable dt = obj.Evaluation_Criteria_BySectionIdSubjectEvlId(obj);
    ...
    protected void list_student_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
        if (list_EvlCriteria.SelectedIndex > 0)
        {
            BindGrid(true);
        }
        }
    ...
    protected void list_EvlCriteria_SelectedIndexChanged(object sender, EventArgs e)
    {

        try
        {
            if (list_EvlType.SelectedValue != "")
            {
