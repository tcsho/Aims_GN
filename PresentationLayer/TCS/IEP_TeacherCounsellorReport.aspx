<%@ Page Language="C#" MasterPageFile="~/PresentationLayer/MasterPage.master" AutoEventWireup="true" CodeFile="IEP_TeacherCounsellorReport.aspx.cs" Inherits="PresentationLayer_TCS_IEP_TeacherCounsellorReport" %>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td id="tdFrmHeading" class="formheading">
                                            <asp:Label ID="Label1" CssClass="lblFormHead" runat="server" Text="Incomplete IEPs Status"></asp:Label>
                                ...
                                <tr class="row">
                                    ...
                                    <td class="col-lg-2 col-md-2 col-xs-10 col-sm-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <asp:DropDownList ID="ddl_region" runat="server" AutoPostBack="True" ValidationGroup="search" CssClass="dropdownlist form-control"
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <div class="table-responsive">
                                ...
                                OnPreRender="gv_details_PreRender"  OnRowCommand="Grid_IEPStudents_RowCommand" OnRowDataBound ="Grid_IEPStudents_RowDataBound"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="Term" SortExpression="Term" HeaderText="Term"></asp:BoundField>
                                    <asp:BoundField DataField="center_name" SortExpression="center_name" HeaderText="School Name"></asp:BoundField>
                                    <asp:BoundField DataField="Class_Name" SortExpression="Class_Name" HeaderText="Class"></asp:BoundField>
                                    <asp:BoundField DataField="Section_Name" SortExpression="Section_Name" HeaderText="Section"></asp:BoundField>
                                    ...
                                    <asp:BoundField DataField="Teacher" SortExpression="Teacher" HeaderText="Teacher Completion"></asp:BoundField>
                                    <asp:BoundField DataField="Teacher" SortExpression="Teacher"  HeaderText="Reason"></asp:BoundField>
                                    <asp:BoundField DataField="Counselor" SortExpression="Counselor" HeaderText="Counselor Status"></asp:BoundField>
                                    <asp:BoundField DataField="CreatedDate" SortExpression="CreatedDate" HeaderText="Updated On"></asp:BoundField>
