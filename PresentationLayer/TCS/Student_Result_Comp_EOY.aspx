<%@ Page Language="C#" MasterPageFile="~/PresentationLayer/MasterPage.master" AutoEventWireup="true" CodeFile="Student_Result_Comp_EOY.aspx.cs" Inherits="PresentationLayer_TCS_Student_Result_Comp_EOY" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Always">
        <ContentTemplate>
            ...
            <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12 form-group ">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <asp:DropDownList CssClass="dropdownlist" runat="server" ID="ddlstatus" OnSelectedIndexChanged="ddlstatus_SelectedIndexChanged" AutoPostBack="true">
                        <asp:ListItem Value="1" Selected="True">Successful</asp:ListItem>
                        <asp:ListItem Value="0">UnSuccessful</asp:ListItem>
                    </asp:DropDownList>
                </div>
