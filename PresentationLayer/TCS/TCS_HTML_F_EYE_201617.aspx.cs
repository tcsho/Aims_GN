...
public partial class PresentationLayer_TCS_TCS_HTML_F_EYE_201617 : System.Web.UI.Page
{
    ...
    protected void Reptr_Student_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        ...
        try
        {
            ...
            if (DistinctResultDate.Rows.Count > 0)
            {
                ...
                if (textbox != null)
                {
                    textbox.Text = Convert.ToDateTime(DistinctResultDate.Rows[0]["ResultDate"].ToString()).ToLongDateString();
                }
            }
        }
        catch (Exception ex)
            ...
            else if (class_id == 5) //Class Class-1
            {
                if (i < 3)
                {
                    ...
                    if (divControl != null)
                    {
                        ...
                        divControl.Style.Add(HtmlTextWriterStyle.PaddingTop, "180px");
                ...
                else if (i >= 3 && i< 7)
                {
                    ...
                    if (divControl != null)
                    {
                        ...
                        divControl.Style.Add(HtmlTextWriterStyle.PaddingTop, "400px");
    ...
    private void UrduSubjectSettings(RepeaterItemEventArgs e)
    {
            ...
            (item.ItemType == ListItemType.AlternatingItem))
        {
                ...
                if(ViewState["Subject_Id"].ToString() == "114" || ViewState["Subject_Id"].ToString() == "123" || ViewState["Subject_Id"].ToString() == "12" || ViewState["Subject_Id"].ToString() == "61")
