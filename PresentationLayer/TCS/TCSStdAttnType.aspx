<%@ Page Title="" Language="C#" MasterPageFile="~/PresentationLayer/MasterPage.master" AutoEventWireup="true" CodeFile="TCSStdAttnType.aspx.cs" Inherits="PresentationLayer_TCS_TSSStdAttnType"     Theme="BlueTheme" %>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td id="tdFrmHeading" class="formheading">
                                            <asp:Label ID="Label1" CssClass="lblFormHead" runat="server" Text="Attendance Leave Types"></asp:Label>
                                        ...
                                        <td align="right" colspan="13" style="height: 19px; text-align: left">
                                            <asp:GridView ID="gvAttnType" runat="server" AllowPaging="True" AllowSorting="True"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="AttnDesc" HeaderText="Description">
                                                        <HeaderStyle HorizontalAlign="Left" />
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="AttCode" HeaderText="Code">
                                                    ...
                                                    <asp:TemplateField HeaderText="Edit">
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:ImageButton ID="Edit" runat="server" CommandArgument='<%# Eval("AttnType_ID") %>'
                                                    ...
                                                    <asp:TemplateField HeaderText="Delete">
                                                         <ItemStyle HorizontalAlign="Center" Width="75px" Wrap="False"></ItemStyle>
                                                          <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                                        <ItemTemplate>
                                                            <asp:ImageButton ID="Delete" runat="server" CommandArgument='<%# Eval("AttnType_ID") %>'
                                    ...
                                    <tr id="trCDTEnt" runat="server" visible="false">
                                        ...
                                        <td align="right" colspan="12" style="height: 19px; text-align: left;">
                                            ...
                                            <asp:RequiredFieldValidator ForColor=Red ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtDescription"
                                                ErrorMessage="Enter Description" ValidationGroup="n" Display="Dynamic"></asp:RequiredFieldValidator><%--<asp:Menu ID="mnuWorkSite" runat="server" Orientation="Horizontal" >
                                    </asp:Menu>--%>
                                        </td>
                                    </tr>
                                    <tr id="trCDTEnt1" runat="server" visible="false">
                                        <td align="right" colspan="1" style="height: 19px; text-align: right">
                                            Code :
                                        </td>
                                        <td align="right" colspan="12" style="height: 19px; text-align: left;">
                                           ...
                                           <%-- <asp:RequiredFieldValidator ForColor=Red ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtDescription"
                                                ErrorMessage="Enter Description" ValidationGroup="n" Display="Dynamic"></asp:RequiredFieldValidator>--%>
                                                <%--<asp:Menu ID="mnuWorkSite" runat="server" Orientation="Horizontal" >
                                    </asp:Menu>--%>
                                        </td>
                                    </tr>
                                    <tr>
