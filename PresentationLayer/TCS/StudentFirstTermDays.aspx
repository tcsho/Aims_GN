<%@ Page Title="" Language="C#" MasterPageFile="~/PresentationLayer/MasterPage.master"
    AutoEventWireup="true" CodeFile="StudentFirstTermDays.aspx.cs" Inherits="PresentationLayer_TCS_StudentFirstTermDays"
    Theme="BlueTheme" %>
        ...
        <ContentTemplate>
         ...
         , //--- Dynamic Language---------
            ...
            <div class="form-group formheading">
                <asp:Label ID="Label1" CssClass="lblFormHead" runat="server" Text="Student Term Days"></asp:Label>
                <img alt="logo" src="<%= Page.ResolveUrl("~")%>images/h01.png" height="100%" width="100%"
                    border="0" />
            </div>
            <br />
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                <div runat="server" id="div3" class="col-lg-5 col-md-5 col-sm-5 col-xs-5 form-group TextLabelMandatory40 text-right">
                </div>
                <div id="Div4" runat="server" class="col-lg-7 col-md-7 col-sm-7 col-xs-7 form-group text-right">
                    <asp:Button runat="server" ID="btnAddPanel" Text="Add" CssClass="btn btn-primary"
                        OnClick="btnAddPanel_Click"></asp:Button>
                </div>
            </div>
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                <br />
                <div runat="server" id="div1" class="col-lg-5 col-md-5 col-sm-5 col-xs-5 form-group TextLabelMandatory40 text-right">
                    Term:
                </div>
                <div runat="server" class="col-lg-7 col-md-7 col-sm-7 col-xs-7 form-group text-left">
                    <asp:DropDownList runat="server" ID="list_Term" CssClass="dropdownlist" AutoPostBack="true"
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-group">
                <asp:Label ID="lblMessage" runat="server" CssClass="TextLabelMandatory40" Text="No Record Exists!"
                    Visible="false"></asp:Label>
                <asp:GridView ID="gvShowAck" runat="server" AutoGenerateColumns="False" CssClass="datatable table table-striped table-bordered table-hover"
                    PageSize="500" Width="100%" OnPreRender="gvShowAck_PreRender">
                    <Columns>
                        <asp:BoundField DataField="Session_Id" HeaderText="Session_Id" ItemStyle-CssClass="hide"
                            HeaderStyle-CssClass="hide">
                            <HeaderStyle CssClass="hide" Font-Size="14px" />
                            <ItemStyle CssClass="hide" Font-Size="14px" />
                        </asp:BoundField>
                        ...
                        <asp:BoundField DataField="Student_Id" HeaderText="Student No">
                            <HeaderStyle ForeColor="White" Font-Size="14px" />
                        ...
                        <asp:BoundField DataField="Section_Name" HeaderText="Section Name" ItemStyle-CssClass="hide"
                            HeaderStyle-CssClass="hide">
                            <HeaderStyle CssClass="hide" />
                            <ItemStyle CssClass="hide" />
                        </asp:BoundField>
                        <asp:BoundField DataField="FirstTermDays" HeaderText="Term Days">
                            <HeaderStyle ForeColor="White" Font-Size="14px" />
                            <ItemStyle Font-Size="14px" />
                        </asp:BoundField>
                        <asp:BoundField DataField="Evaluation_Criteria_Type_Id" ItemStyle-CssClass="hide"
                            HeaderStyle-CssClass="hide" HeaderText="Evaluation_Criteria_Type_Id">
                            <HeaderStyle CssClass="hide" />
                            <ItemStyle CssClass="hide" />
                        </asp:BoundField>
                        <asp:BoundField DataField="Section_Id" ItemStyle-CssClass="hide" HeaderStyle-CssClass="hide"
                            HeaderText="Section_Id">
                            <HeaderStyle CssClass="hide" />
                            <ItemStyle CssClass="hide" />
                        </asp:BoundField>
                        <asp:TemplateField HeaderText="Delete">
                            <ItemStyle Font-Size="14px" />
                            <ItemTemplate>
                                <asp:LinkButton runat="server" ID="btnDelete" OnClick="btnDelete_Click" OnClientClick="javascript:return confirm('Are you sure you want to Delete?');"
            ...
            <div runat="server" id="SearchPanel" visible="false">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-right ">
                    ...
                    <asp:Button ID="btnSave" OnClick="btnSave_Click" runat="server" CssClass="btn btn-primary"
                        Visible="false" Text="Save"></asp:Button>&nbsp;
                    <asp:Button ID="btnCancelPanel" runat="server" Text="Cancel" CssClass="btn btn-danger"
                    ...
                    <asp:GridView ID="dg_student" runat="server" DataKeyNames="student_id" CssClass="datatable table table-striped table-bordered table-hover"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Total Working Days">
                                ...
                                <ItemStyle HorizontalAlign="Center" Font-Size="14px" />
                                <ItemTemplate>
                                    <asp:TextBox ID="txtDaysWork" runat="server" Width="100px" CssClass="form-control textbox"></asp:TextBox>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Days Attended">
                                <%--13--%>
                                <HeaderStyle HorizontalAlign="Center" Font-Size="14px" />
                                <ItemStyle HorizontalAlign="Center" Font-Size="14px" />
                                <ItemTemplate>
                                    <asp:TextBox ID="txtAttendDay" runat="server" Width="100px" CssClass="form-control textbox">
                                    </asp:TextBox>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
