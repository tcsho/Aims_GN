...
public partial class PresentationLayer_TCS_TCS_HTML_F_O_A_B : System.Web.UI.Page
{
    ...
    protected void Reptr_Student_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        ...
        try
        {
                ...
                (item.ItemType == ListItemType.AlternatingItem))
            {
                ...
                DataView dv = new DataView(dt);
                DataTable DistinctSubjects = dv.ToTable(true, "Subject_Id", "Student_No", "SubjectNameCom", "Course_Work", "Theory_Exam", "Marks", "Grade");
