...
public partial class PresentationLayer_TCS_IEP_StudentsResults_EOY : System.Web.UI.Page
{
    ...
    public void exec_SP()
    {
        ...
        if (ddlrptname.SelectedValue.ToString().Trim() == "1")
        {
            ...
            Label1.Text = "Student Result  Winter Campus-(EOY)";
        }
        else
        {
            dt = objBase.sqlcmdFetch("sp_ResultStudentAll_EOY", param);
            Label1.Text = "Student Result-(EOY)";
        }
        if (dt.Rows.Count > 0)
        {
