<%@ Page Title="" Language="C#" MasterPageFile="~/PresentationLayer/MasterPage.master"
    AutoEventWireup="true" CodeFile="LMSAnnouncementsforStudent.aspx.cs" Inherits="PresentationLayer_TCS_LMSAnnouncementsforStudent" Theme="BlueTheme" %>
                        ...
                        <td colspan="3">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td id="tdFrmHeading" class="formheading">
                                            <asp:Label ID="Label1" CssClass="lblFormHead" runat="server" Text="Student Announcements"></asp:Label>
                            ...
                            top: 2px" />
                                        ...
                                        <td align="right" class="titlesection" colspan="2" style="height: 19px; text-align: left">
                                            Student Announcements Information
                                        </td>
                                    </tr>
                                            </table>
                                        </td>
                                    ...
                                    <tr>
                                        <td align="right" colspan="13" style="height: 19px; text-align: left">
                                            <asp:GridView ID="gvDetail" runat="server" AllowPaging="True" AllowSorting="True"
                                                ...
                                                <Columns>
                                                    <asp:BoundField DataField="Announcement_ID" HeaderText="Announcement_ID" 
                                                        Visible="False">
                                                    </asp:BoundField>
                                                    ...
                                                    <asp:BoundField DataField="AncmtTitle" HeaderText="AncmtTitle"
                                                        HtmlEncode="False">
                                                        <HeaderStyle HorizontalAlign="Left" Width="80px" />
                                                        <ItemStyle HorizontalAlign="Left" Width="80px" />
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="AncmtBody" HeaderText="AncmtBody">
                                                    ...
                                                    <asp:BoundField DataField="PublishStartDate" HeaderText="PublishStartDate">
                                                        <HeaderStyle HorizontalAlign="Left" Width="100px" />
                                                        <ItemStyle HorizontalAlign="Left" Width="100px" />
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="PublishEndDate" HeaderText="PublishEndDate" >
                                                    ...
                                                    <asp:TemplateField HeaderText="Show">
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:ImageButton ID="Edit" runat="server" CommandArgument='<%# Eval("Announcement_ID") %>'
                                                    ...
                                                    <asp:TemplateField HeaderText="Delete" Visible="False">
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:ImageButton ID="Delete" runat="server" CommandArgument='<%# Eval("Announcement_ID") %>'
