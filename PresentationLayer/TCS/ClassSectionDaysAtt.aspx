<%@ Page Title="" Language="C#" MasterPageFile="~/PresentationLayer/MasterPage.master"
    AutoEventWireup="true" CodeFile="ClassSectionDaysAtt.aspx.cs" Inherits="PresentationLayer_TCS_ClassSectionDaysAtt"
    Theme="BlueTheme" %>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td id="tdFrmHeading" class="formheading">
                                            <asp:Label ID="Label1" CssClass="lblFormHead" runat="server" Text="Term Attended Days"></asp:Label>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:DropDownList ID="list_term" runat="server" AutoPostBack="True" CssClass="dropdownlist"
                                            OnSelectedIndexChanged="list_term_SelectedIndexChanged" Width="250px">
                                        </asp:DropDownList>
                                    </td>
                                </tr>
                            </table>
                        ...
                        <td valign="top" colspan="3">
                            <asp:GridView ID="gvRegStudents" SkinID="GridView" runat="server" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="StudentNameId" HeaderText="Roll # - Student Name">
                                    <ItemStyle Font-Size="14px"  />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="Gender" HeaderText="Gender"><ItemStyle Font-Size="14px"  /></asp:BoundField>
                                    <asp:BoundField DataField="Section_Name" HeaderText="Section "><ItemStyle Font-Size="14px"  /></asp:BoundField>
                                    <asp:TemplateField HeaderText="Days Attended">
                                        <ItemTemplate>
                                            
<asp:TextBox ID="txt_DaysAttended" runat="server" CssClass="Textbox" ></asp:TextBox>
                                            <asp:RangeValidator ID="DARVal" runat="server" Type="Integer" MinimumValue="0" ControlToValidate="txt_DaysAttended"
                                                ForeColor="Red" ValidationGroup="valSave" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField Visible="false" HeaderText="Achievement Rating/Comments">
                                        <ItemTemplate>
                                    ...
                                    <asp:BoundField DataField="WorkingDays" SortExpression="WorkingDays" HeaderText="WorkingDays">
<ItemStyle Font-Size="14px"  />
                                    </asp:BoundField>
                                </Columns>
                    ...
                    <tr>
                        <td valign="top" colspan="3" style="text-align:center;padding-top:2%;">
                            <asp:Button ID="but_save" runat="server" CssClass="btn btn-primary" OnClick="Button1_Click"
                                Text="Save" ValidationGroup="valSave" Width="100px"/>
                        </td>
                    </tr>
                </tbody>
            </table>
