<%@ Page Title="" Language="C#" MasterPageFile="~/PresentationLayer/MasterPage.master"
    AutoEventWireup="true" CodeFile="StudentCriteriaMarksAllSubjects.aspx.cs" Inherits="PresentationLayer_StudentCriteriaMarksAllSubjects" %>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td id="tdFrmHeading" class="formheading">
                                            <asp:Label ID="Label1" CssClass="lblFormHead" runat="server" Text="Student's Result - Subject Wise"></asp:Label>
                                    ...
                                    <td style="width: 100%">
                                        ...
                                        <asp:GridView ID="dv_details" runat="server" AllowPaging="True" AllowSorting="True"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="Session_Id" HeaderText="Session_Id" Visible="False"></asp:BoundField>
