<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TCS_HTML_F_O_A_B.aspx.cs" Inherits="PresentationLayer_TCS_TCS_HTML_F_O_A_B" %>
                        ...
                        <table style="width: 97%; margin-left: 10px;">
                            <tr style="height: 2px; white-space: nowrap;">
                                <td width="25%" style="padding: 10px; text-align: left;">
                                 ...
                                 <td width="14%" style="padding: 10px; text-align: left;">
