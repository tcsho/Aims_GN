<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TCS_HTML_S_O_A201718.aspx.cs" Inherits="PresentationLayer_TCS_TCS_HTML_S_O_A201718" %>
    ...
    <form id="Form1" runat="server">
        <asp:Repeater ID="Reptr_Student" runat="server" OnItemDataBound="Reptr_Student_ItemDataBound">
            <ItemTemplate>
                ...
                <div id="blue_border" style="width: 900px; height: 1310px; padding: 10px; border: 0px solid blue; display: inline-block; position: relative;">
                ...
                padding: 10px; border: 4px solid #275797; display: inline-block;">--%>
                    ...
                    <div id="main_header" style="width: 100%;">
                        ...
                        <div id="city_school_title_info" style="float: center">
                            ...
                            <div id="city-school-header-text" style="font-family: Arial; line-height: 0.5; padding-left: 90px; padding-right: 90px;">
                                <h3 style="font-weight: lighter; padding-top: 5px; text-align: center;">Mock Examination  <%#Eval("SessionCode") %> 
                                </h3>
                                <br />
                        ...
                        <ItemTemplate>
                            ...
                            <tr style="height: 2px;">
                                ...
                                <td>
                                    ...
                                    <span id="dash" runat="server" visible='<%#(Eval("Grade").ToString()== "-")?true:false%>'>
                                        -

                                    </span>
                                    <span id="marks" runat="server" visible='<%#(Eval("Grade").ToString()== "-")?false:true%>'>
                                        <%#Eval("Marks") %>
                                    </span>
                    ...
                    <table style="width: 97%; margin-left: 10px;">
                        <tr>
                            <td width="26.5%" style="padding: 5px; widht: 25%; text-align: left">Overall Exam %
                            </td>
                            <td width="5%">
                                <%#Eval("Overall_P") %>
                            </td>
                            <td width="23%" style="padding: 5px; text-align: left">Overall Exam Grade
                            </td>
                            <td width="7%">
                                <%#Eval("Overall_G") %>
                            </td>
                        ...
                        <tr>
                            <table style="width: 97%; margin-left: 10px;">
                                <tr>
                                    <td style="padding: 5px; text-align: left; width: 18%">Class Highest Exam %
                                    </td>
                                    <td style="width: 8.5%">
                                        <%#Eval("Class_Heighest") %>
                                    </td>
                                    <td style="padding: 5px; text-align: left; width: 20.9%">Class Lowest Exam %
                                    </td>
                                    <td style="width: 15%">

                                        <%#Eval("ClassMinimum") %>
                                    </td>
                                    <td style="padding: 5px; text-align: left; width: 19.8%">Class Average Exam %
                                    </td>
                                    <td style="width: 10.5%">
                                        <%#Eval("Class_Average") %>
                                    </td>
                    ...
                    <div id="performance-indicators" style="padding-top: 20px; padding-bottom: 5px; text-align: center; width: 100%;">
                        <p>
                            <strong>PERFORMANCE INDICATORS</strong>
                        </p>
                    </div>
                    <div id="performance-indicators-table" style="margin-left: 10px; padding-top: 10px; padding-bottom: 5px; padding-left: 20px; padding-right: 20px; width: 92%; height: 50px; border: 2px solid black; display: inline-block;">
