<%@ Page Title="" Language="C#" MasterPageFile="~/PresentationLayer/MasterPage.master"
    AutoEventWireup="true" CodeFile="LmsSchEventMain.aspx.cs" Inherits="PresentationLayer_TCS_LmsSchEventMain" validateRequest="false" %>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td id="tdFrmHeading" class="formheading">
                                            <asp:Label ID="Label1" CssClass="lblFormHead" runat="server" Text="Teacher Main Scheduling "></asp:Label>
                                ...
                                &nbsp;&nbsp;
                                 ...
                                 <tr style="width: 100%">
                                        ...
                                        <td style="height: 18px; width: 40%; text-align: right" align="right" colspan="1">
                                            <asp:LinkButton ID="btnCompose" runat="server" CausesValidation="False" OnClick="btnSchForm_Click">Add / Update New Scheduling Event</asp:LinkButton>
                                        </td>
                                    </tr>
