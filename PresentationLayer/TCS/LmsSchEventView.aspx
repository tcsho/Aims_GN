<%@ Page Title="" Language="C#" MasterPageFile="~/PresentationLayer/MasterPage.master"
    AutoEventWireup="true" CodeFile="LmsSchEventView.aspx.cs" Inherits="PresentationLayer_TCS_LmsSchEventView" Theme="BlueTheme" %>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td id="tdFrmHeading" class="formheading">
                                            <asp:Label ID="Label1" CssClass="lblFormHead" runat="server" Text="Student Scheduling View"></asp:Label>
                            ...
                            top: 2px" />
                                            ...
                                            <asp:GridView ID="gvDetail" runat="server" AllowPaging="True" AllowSorting="True"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="View">
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:ImageButton ID="View" runat="server" CommandArgument='<%# Eval("Event_ID") %>'
                                                                ImageUrl="~/images/edit.gif" OnClick="btnEdit_Click" ToolTip="View" />
                                                        </ItemTemplate>
                                    ...
                                    <tr id="trCDT" runat="server" visible="false">
                                        <td align="right" class="titlesection" colspan="13" style="height: 19px; text-align: left">
                                            Student Scheduling Other Information
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width: 100%;">
