...
public partial class PresentationLayer_TCS_TCS_HTML_F_O_A_B_201920 : System.Web.UI.Page
{
    ...
    public void LoadReport()
    {
        try
        {
            ...
            DataTable DistinctStudent = dv.ToTable(true, "Student_No", "Student_Id", "StudentName", "Class_Name", "Section_Name", "Strength", "DaysPresent", "Student_Age", "Class_Avg_Age", "Overall_P", "Class_Heighest", "Class_Average", "Overall_G", "ClassTeacher_Comments", "FirstTermDaysCH", "Main_Organisation_Name", "Evaluation_Criteria_Type_Name", "Center_Name", "PromotedToClass", "TtlAct", "isPromoted", "Region_Id", "Cond_Prom", "SessionCode", "ClassMinimum", "Class_Id", "Session_Id");
    ...
    protected void Reptr_Student_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        ...
        try
        {
                ...
                (item.ItemType == ListItemType.AlternatingItem))
            {
                ...
                dt3.Columns.Add(new DataColumn("CourseworkGrade", typeof(string)));
                ...
                DataTable DistinctSubjects = dv.ToTable(true, "Subject_Id", "Student_No", "SubjectNameCom", "Course_Work", "Theory_Exam", "Marks", "Grade", "OrderofSubject", "CourseworkGrade");
                ...
                {
                    dt3.NewRow();
                    dt3.Rows.Add(t["Subject_Id"], t["SubjectNameCom"], t["Course_Work"], t["Theory_Exam"], t["Marks"], t["Grade"], t["CourseworkGrade"]);
                }
