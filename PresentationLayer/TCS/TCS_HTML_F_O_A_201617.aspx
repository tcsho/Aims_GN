<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TCS_HTML_F_O_A_201617.aspx.cs" Inherits="PresentationLayer_TCS_TCS_HTML_F_O_A_201617" %>
            ...
            <ItemTemplate>
                ...
                padding: 10px; border: 4px solid #275797; display: inline-block;">--%>
                    ...
                    <div style="position: absolute; bottom: 40px; margin-left: 10px;">
                        ...
                        <p id="P2" runat="server" style="padding-left: 25px; bottom: 0;" visible='<%#(Eval("isPromoted").ToString() == "False"  && Eval("SessionCode").ToString()=="2016-2017" &&   Eval("Cond_Prom").ToString().Length < 1 )?true:false%>'>
                ...
                <div id="UnderTaking_9" runat="server" style="width: 900px; height: 1250px; padding: 10px; font-family: Century; border: 0px solid blue; display: inline-block; position: relative; margin-top: 45px;"
                ...
                <div id="Undertaking_10" runat="server" style="width: 900px; height: 1285px; padding: 10px; font-family: Century; border: 0px solid blue; display: inline-block; position: relative; margin-top: 45px;"
                    ...
                    <div id="Div9" style="padding-left: 50px; padding-right: 60px; text-align: justify; font-size: 18px;">
                        ...
                        <div id="Div10" style="float: left;">
                            ...
                            <p id="P6" runat="server" style="padding-left: 25px;" visible='<%#(Eval("Class_Id").ToString() == "13" || Eval("Class_Id").ToString() == "14" || Eval("Class_Id").ToString() == "15" )?false:true%>'>
                                <strong>Date:</strong> 30<sup>th</sup> December 2016.
                            </p>
                        ...
                        <p style='text-align: justify; line-height: 150%;'>
                            <b><span style='padding-left: 11%; font-size: 14.0pt; line-height: 150%; color: #990000'>Head of School</span> 
