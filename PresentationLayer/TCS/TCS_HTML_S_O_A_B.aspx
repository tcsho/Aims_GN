<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TCS_HTML_S_O_A_B.aspx.cs" Inherits="PresentationLayer_TCS_TCS_HTML_S_O_A_B" %>
    ...
    <asp:Repeater ID="Reptr_Student" runat="server" OnItemDataBound="Reptr_Student_ItemDataBound">
        <ItemTemplate>
            ...
            <div id="blue_border" style="width: 900px; height: 1310px; padding: 10px; border: 1px solid blue;
                ...
                <p style="padding-left: 15px; padding-top: 50px; bottom: 10;">
                    *This is a system generated report and does not require any signature and stamp.</p>
                     <strong>Date:</strong> 14<sup>th</sup> April 2017.
                <%--<script type="text/javascript">
                    now = new Date();
                    localtime = now.toDateString().toString();
                    localtime = localtime + ' ' + now.getHours().toString() + ':' + now.getMinutes().toString();
                    document.write("<p style=\"padding-left: 15px; padding-bottom:20px;padding-top: 40px; bottom: 0;\"><strong>Date: 14<sub>th</sub> April, 2017</strong> "
//                    + localtime 
                    +"</p>");
