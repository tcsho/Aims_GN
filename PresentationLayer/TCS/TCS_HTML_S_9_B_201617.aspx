<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TCS_HTML_S_9_B_201617.aspx.cs"
    Inherits="PresentationLayer_TCS_TCS_HTML_S_9_B_201617" %>
        ...
        <ItemTemplate>
            ...
            <div id="blue_border" style="width: 900px; height: 1295px; padding: 10px; border: 1px solid blue;
                ...
                <div style="position: absolute; bottom: 0px; left: 0px;">
                    ...
                    <p id="P11" runat="server" style="padding-left: 25px; bottom: 0;" visible='<%#(Eval("isPromoted").ToString() == "False" && Eval("Cond_Prom").ToString().Length >= 1 )?true:false%>'>
               ...
               <p id="P101" runat="server" style="padding-left: 25px; padding-top: 20px; bottom: 0;"
                   visible='<%#(Eval("SessionCode").ToString() == "2016-2017")?true:false%>'><strong>Date: 2<sup>nd</sup> June 2017.</strong>
                  </p>

                  <p id="P102" runat="server" style="padding-left: 25px; padding-top: 20px; bottom: 0;"
