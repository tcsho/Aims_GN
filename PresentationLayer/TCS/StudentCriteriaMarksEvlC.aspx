<%@ Page Title="" Language="C#" MasterPageFile="~/PresentationLayer/MasterPage.master"
    AutoEventWireup="true" CodeFile="StudentCriteriaMarksEvlC.aspx.cs" Inherits="PresentationLayer_StudentCriteriaMarksEvlC" Theme="BlueTheme" %>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td id="tdFrmHeading" class="formheading">
                                            <asp:Label ID="Label1" CssClass="lblFormHead" runat="server" Text="Exam/ Course Work and Theory Marks By Evaluation Criteria"></asp:Label>
                        ...
                        <td>
                            <table class="main_table" cellspacing="0" cellpadding="0" width="100%" align="center"
                                ...
                                <tr style="width: 100%">
                                    ...
                                    <td align="left" style="width: 60%">
                                        <asp:DropDownList ID="list_EvlCriteria" runat="server" AutoPostBack="True" 
                                            CssClass="dropdownlist" 
                                            OnSelectedIndexChanged="list_EvlCriteria_SelectedIndexChanged" Width="217px">
                                        </asp:DropDownList>
                                    </td>
                                </tr>
                            </table>
