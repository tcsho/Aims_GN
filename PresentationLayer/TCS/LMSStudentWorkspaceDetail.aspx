<%@ Page Title="" Language="C#" MasterPageFile="~/PresentationLayer/MasterPage.master"
    AutoEventWireup="true" CodeFile="LMSStudentWorkspaceDetail.aspx.cs" Inherits="PresentationLayer_LMSTeacherWorkspaceDetail" %>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td id="tdFrmHeading" class="formheading">
                                            <asp:Label ID="Label1" CssClass="lblFormHead" runat="server" Text="Student Workspace Detail - Worksite Wise All Information"></asp:Label>
