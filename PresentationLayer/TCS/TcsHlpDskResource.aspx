<%@ Page Title="" Language="C#" MasterPageFile="~/PresentationLayer/MasterPage.master"
    AutoEventWireup="true" CodeFile="TcsHlpDskResource.aspx.cs" Inherits="PresentationLayer_TCS_TcsHlpDskResource"
    Theme="BlueTheme" %>
        ...
        <ContentTemplate>
         ...
         //          );
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 " runat="server" id="ContentDetailSection">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-group">
                        <asp:Label ID="Label2" runat="server" CssClass="col-lg-3 col-md-3 col-sm-3 col-xs-12 TextLabelMandatory40"
                            Text="Employee Code: "></asp:Label>
                        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                            <asp:TextBox ID="txtName" runat="server" CssClass="form-control textbox" MaxLength="50"></asp:TextBox>
                            <asp:RequiredFieldValidator ForColor="Red" ID="RequiredFieldValidator1" runat="server"
                                ValidationGroup="s" Display="Dynamic" ErrorMessage="MCatDesc name is required."
                ...
                <div class="row">
                    <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12 text-right ">
                        ...
                        <asp:Button ID="btnCancel" runat="server" CssClass="btn btn-primary" Text="Cancel"
                            Width="58px" Visible="false" OnClick="btnCancel_Click" /><br /><br />
                    </div>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-group">
                <asp:GridView ID="gvDCT" SkinID="GridView" runat="server" AutoGenerateColumns="False"
                    CssClass="datatable table table-hover table-responsive" OnPreRender="gvDCT_PreRender"
                    ...
                    <Columns>
                           ...
                           <HeaderStyle CssClass="hide" />
                            ...
                            <ItemTemplate>
                                <asp:LinkButton ID="btnTitle" runat="server" ForeColor="#004999" OnClick="btnTitle_Click"
                                    Style="text-align: center; font-weight: normal;" Text='<%# Eval("EmployeeCode") %>  '
                                    ToolTip="View this Record" CommandArgument='<%# Eval("HD_Resource_ID") %>'></asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>  
                        ...
                        <asp:BoundField DataField="EmployeeName" HeaderText="Resource Full Name">
                            <HeaderStyle Width="50%" />
                            <ItemStyle Width="50%" />
                        </asp:BoundField>
                        <asp:TemplateField HeaderText="Edit">
                            <ItemStyle Wrap="False" HorizontalAlign="Center" Width="10%" CssClass="hide" />
                            <HeaderStyle CssClass="hide" />
                            <ItemTemplate>
                                <asp:ImageButton ID="btnEdit" runat="server" ForeColor="#004999" OnClick="btnEdit_Click"
                                    ...
                                    CommandArgument='<%# Eval("HD_Resource_ID") %>'></asp:ImageButton>
                            </ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Remove">
                            ...
                            <ItemTemplate>
                                <asp:ImageButton ID="btnRemove" runat="server" ForeColor="#004999" OnClick="btnRemove_Click"
                                    ...
                                    CommandArgument='<%# Eval("HD_Resource_ID") %>' OnClientClick="javascript:return confirm('Are you sure to Delete this Record?');">
                                </asp:ImageButton>&nbsp;
                            </ItemTemplate>
                            <HeaderStyle HorizontalAlign="Center" />
                        </asp:TemplateField>
