    ...
    <form id="Form1" runat="server">
        <asp:Repeater ID="Reptr_Student" runat="server" OnItemDataBound="Reptr_Student_ItemDataBound">
            <ItemTemplate>
                ...
                <div id="blue_border" style="background-color: white; width: 900px; padding: 10px; border: 4px solid #fff;">
                    <!--//////////////////////////////////////-->
        ...
        <!-- NEW Session  -->
        <asp:Repeater ID="Reptr_Student_2025" runat="server" OnItemDataBound="Reptr_Student_ItemDataBound">
            <ItemTemplate>
                <asp:HiddenField ID='Student_No' runat="server" Value='<%#Eval("Student_Id") %>' />
                <asp:HiddenField ID='Class_Id' runat="server" Value='<%#Eval("Class_Id") %>' />
                <!--This div is for outer blue boundary. height should be changed manualy according to requirement-->
                <div id="blue_border" style="background-color: white; width: 900px; padding: 10px; border: 4px solid #fff;">
                            ...
                            <HeaderTemplate>
                                <table style="width: 100%; height: auto; margin-left: 10px; border: none">
                                    <tr>
                                        ...
                                        <td width="4.9%" style="padding: 0px 5px;">
                                            <center>
                                                <strong>Exceeding Development</strong></center>
                                        </td>
                                        <td width="5.1%" style="padding: 0px 5px;">
                                            <center>
                                                <strong>Expected Development</strong></center>
                                        </td>
                                        <td width="5.1%" style="padding: 0px 5px;">
                                        ...
                                        <asp:Repeater ID="GenPerKeys" runat="server" OnItemDataBound="Reptr_GP_ItemDataBound">
                                            ...
                                            <ItemTemplate>
                                                <tr id="pecrItem" runat="server" style="width: 100%; height: 28px; border-top-width: 0; border-left-width: 0; border-right-width: 0;">
                                                    ...
                                                    <td style="text-align: center; width: 12.5%; border-top-width: 0; border-right-width: 0; border-bottom-width: 0;">
                                                        <%#Eval("Key3").ToString()=="True" ?"&#10004;":""%>
                                                    </td>
                                                    <td style="text-align: center; width: 12.5%; border-top-width: 0; border-right-width: 0; border-bottom-width: 0;">
                                                        <%#Eval("Key2").ToString()=="True" ?"&#10004;":""%>
                 ...
                 <p>
                     <strong>Needs Improvement: </strong><span style="margin-left: 42px;">Performs below the emerging level</span>
                 </p>
                 ...
                 <p>
                     <strong>Exceeding Development: </strong><span style="margin-left: 5px;">Performs above the expected level, showing advanced skills. (EXC )</span>
                 </p>
                 <p>
                     <strong>Expected Development: </strong><span style="margin-left: 5px;">Performs at the expected level, consistently meeting the learning outcomes independently. (EXP )</span>
                 </p>
                 <p>
                     <strong>Emerging Development: </strong><span style="margin-left: 5px;">Performs below the expected level, requiring some assistance to meet the learning outcomes. (EME )</span>
                 </p>
                 <p>
                     <strong>Needs Improvement: </strong><span style="margin-left: 5px;">Performs below the emerging level, requiring constant assistance and guidance, and not usually meeting the learning outcomes. (N.I )</span>
                 </p>
                    ...
                    <div class="performance-indicators">
                        ...
                        <p class="indicator"><span "><strong>Exceeding Development:</strong></span> <span style="margin-left:0px;">Performs above the expected level, showing advanced skills. (EXC)</span></p>
                        <p class="indicator"><span "><strong>Expected Development:</strong></span><span style="margin-left:7px;"> Performs at the expected level, consistently meeting the learning outcomes independently. (EXP)</span></p>
                        <p class="indicator"><span "><strong>Emerging Development:</strong></span> <span style="margin-left: 3px;">Performs below the expected level, requiring some assistance to meet the learning outcomes. (EME)</span></p>
                        <p class="indicator"><span "><strong>Needs Improvement:</strong></span><span style="margin-left:33px;">Performs below the emerging level, requiring constant assistance and guidance, and not usually meeting the learning outcomes. (N.I)</span></p>
                    </div>
                </div>
            </ItemTemplate>
            <SeparatorTemplate>
