<%@ Page Title="" Language="C#" MasterPageFile="~/PresentationLayer/MasterPage.master"
    AutoEventWireup="true" CodeFile="LmsPolls.aspx.cs" Inherits="PresentationLayer_TCS_LmsPolls" Theme="BlueTheme" %>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td id="tdFrmHeading" class="formheading">
                                            <asp:Label ID="Label1" CssClass="lblFormHead" runat="server" Text="Teacher Polls"></asp:Label>
                                            ...
                                            <asp:GridView ID="gvDetail" runat="server" AllowPaging="True" AllowSorting="True"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Edit">
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:ImageButton ID="Edit" runat="server" CommandArgument='<%# Eval("Poll_ID") %>'
                                                    ...
                                                    <asp:TemplateField HeaderText="Delete">
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:ImageButton ID="Delete" runat="server" CommandArgument='<%# Eval("Poll_ID") %>'
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="btnShowQuestion" runat="server" 
                                                            CommandArgument='<%# Eval("Poll_ID") %>' ForeColor="#004999" 
                                                ...
                                                <asp:TemplateField HeaderText="Edit">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="btnQuestionDTEdit" runat="server" 
                                                            CommandArgument='<%# Eval("PollDetail_ID") %>' ForeColor="#004999" 
