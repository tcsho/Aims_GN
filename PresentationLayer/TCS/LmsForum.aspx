<%@ Page Title="" Language="C#" MasterPageFile="~/PresentationLayer/MasterPage.master"
    AutoEventWireup="true" CodeFile="LmsForum.aspx.cs" Inherits="PresentationLayer_TCS_LmsForum" Theme="BlueTheme" %>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td id="tdFrmHeading" class="formheading">
                                            <asp:Label ID="Label1" CssClass="lblFormHead" runat="server" Text="Teacher Forum"></asp:Label>
                                        ...
                                        <td align="right" colspan="13" style="height: 19px; text-align: left">
                                            <asp:GridView ID="gvDetail" runat="server" AllowPaging="True" AllowSorting="True"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="ForumTitle" HeaderText="ForumTitle"
                                                        HtmlEncode="False">
                                                    ...
                                                    <asp:TemplateField HeaderText="Edit">
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:ImageButton ID="Edit" runat="server" CommandArgument='<%# Eval("Forum_ID") %>'
                                                    ...
                                                    <asp:TemplateField HeaderText="Delete">
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:ImageButton ID="Delete" runat="server" CommandArgument='<%# Eval("Forum_ID") %>'
