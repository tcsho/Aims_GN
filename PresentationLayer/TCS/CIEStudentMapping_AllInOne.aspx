<%@ Page Title="" Language="C#" MasterPageFile="~/PresentationLayer/MasterPage.master"
    AutoEventWireup="true" CodeFile="CIEStudentMapping_AllInOne.aspx.cs" Inherits="PresentationLayer_TCS_CIEStudentMapping_AllInOne"
    Theme="BlueTheme" %>
                        ...
                        <td colspan="3">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td id="tdFrmHeading" class="formheading">
                                            <asp:Label ID="Label1" CssClass="lblFormHead" runat="server" Text="Students Roll No. Mapping with CAIE Candidate No."></asp:Label>
                            ...
                            <table class="main_table" cellspacing="0" cellpadding="0" width="100%" align="center"
                                ...
                                <tbody>
                                    ...
                                    <tr id="tr5" runat="server" style="text-align: center">
                                        <td colspan="13">
                                            <asp:Button ID="highAch" runat="server" CssClass="btn btn-primary" OnClick="btnCompile_Click"
                                                Text="Compile High Achievers" />
                                            <%--ValidationGroup="a"--%>
                                            &nbsp;
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td align="right" colspan="13" style="height: 19px; text-align: left">
                                            <asp:GridView ID="gvAttnTypedt" runat="server" AllowPaging="True" AllowSorting="True"
                                                ...
                                                PageSize="8000" SkinID="GridView" Width="100%">
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="CIECenterName" HeaderText="Center Name (CAIE)"></asp:BoundField>
                                                    ...
                                                    <asp:BoundField DataField="Center_Name" HeaderText="Center Name (AIMS)"></asp:BoundField>
                                                    <asp:BoundField DataField="Student_CNIC" HeaderText="Student CNIC"></asp:BoundField>
                                                    <asp:BoundField DataField="MappedFrom" HeaderText="Mapped Status"></asp:BoundField>
                                                </Columns>
