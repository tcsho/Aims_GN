<%@ Page Title="" Language="C#" MasterPageFile="~/PresentationLayer/MasterPage.master"
    AutoEventWireup="true" CodeFile="LMSAnnouncements.aspx.cs" Inherits="PresentationLayer_TCS_LMSAnnouncements" Theme="BlueTheme" %>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td id="tdFrmHeading" class="formheading">
                                            <asp:Label ID="Label1" CssClass="lblFormHead" runat="server" Text="Teacher Announcements"></asp:Label>
                            ...
                            top: 2px" />
                                    ...
                                    <tr id="trCDT" runat="server" visible="false">
                                        <td align="right" class="titlesection" colspan="13" style="height: 19px; text-align: left">
                                            Add / Update Teacher Announcements
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width: 100%;">
