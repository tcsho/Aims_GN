<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TCS_HTML_S_9_B.aspx.cs" Inherits="PresentationLayer_TCS_TCS_HTML_S_9_B" %>
...
<body style="">
    ...
    <asp:Repeater ID="Reptr_Student" runat="server" OnItemDataBound="Reptr_Student_ItemDataBound">
     ...
     <div id="student-credentials" style="width: 97%;">
                ...
                <div style="position: absolute; bottom: 20px; margin-left: 10px;">
...
<%--                <p id="P2" runat="server" style="padding-left: 25px; bottom: 0;" visible='<%#(Eval("isPromoted").ToString() == "True")?false:true%>'>
                    ...
                    <p style="padding-left: 15px; padding-top: 20px; bottom: 10;">
...
<%--                <script type="text/javascript">
                    ...
                    document.write("<p style=\"padding-left: 15px; padding-top: 20px; bottom: 0;\"><strong>Date:</strong> " + localtime +"</p>");
                        ...
                        <div id="Div6" runat="server" style="width: 900px; height: 1310px; padding: 10px; border: 1px solid blue;
                ...
                <div id="Div4" style="width: 100%;">
                    <div id="Div7" align="right" style="float: right;" width='100' height="75">
                        <img src="../../images/city_school_logo.png" width="90" height="100">
                    </div>
                    <div id="Div8" style="float: center">
                        <div id="Div9" style=";padding-left:90px;padding-right:90px;">
                            <center>
                                <img src="../../images/city_06.png" width="253" height="53"></center>
                        </div>
                        <div id="Div10" style="font-family: Arial; line-height: 0.5; text-align:center;padding-left:90px;padding-right:90px;">
