<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TCS_HTML_S_3_8_B_201920.aspx.cs" Inherits="PresentationLayer_TCS_TCS_HTML_S_3_8_B_201920" %>
           ...
           OnClick="Button1_Click"/>
                    ...
                    <asp:Repeater ID="Reptr_Student" runat="server" OnItemDataBound="Reptr_Student_ItemDataBound">
                        <ItemTemplate>
                            ...
                            <div id="blue_border" style="width: 900px; height: 1295px; padding: 10px; border: 2px solid blue; display: inline-block; position: relative; margin-top: 15px;">
                                    ...
                                    <HeaderTemplate>
                                        <table style="width: 97%; margin-left: 10px;">
                                            <tr style="height: 2px; white-space: nowrap;">
                                                <td width="27%" style="padding: 10px; text-align: left;">
                                                ...
                                                <td width="12%">
                                                    <strong>
                                                        <center>
                                                            ...
                                                            <br>
                                                            <strong>Class Learning %</strong></center>
                                                    </strong>
                                                </td>
                            ...
                            <strong>Academic Grade</strong><span class="bottompara"><strong>A*</strong> = 90-100,</span><span
                                ...
                                <div style="position: absolute; bottom: 0px; left: 0px;">
                                    <p id="P3" runat="server" style="padding-left: 25px; bottom: 0; margin-bottom: -12px;" visible='<%#(Eval("isPromoted").ToString()== "True")?true:false%>'>
                                        Promoted To: <strong style="text-decoration: underline;">
                                            <%#Eval("PromotedToClass")%></strong>

                                    </p>

                                    <p id="P4" runat="server" style="padding-left: 25px; bottom: 0; margin-bottom: -12px;" visible='<%#(Eval("isPromoted").ToString() == "False" && Eval("Cond_Prom").ToString().Length < 1)?true:false%>'>
                                        <strong style="text-decoration: underline;">Not Promoted</strong>

                                    </p>

                                    <p id="P5" runat="server" style="padding-left: 25px; bottom: 0; margin-bottom: -12px;" visible='<%#(Eval("isPromoted").ToString() == "False" && Eval("Cond_Prom").ToString().Length >= 1 )?true:false%>'>
                                    ...
                                    <p id="P6" runat="server" style="padding-left: 66px; padding-top: 20px; bottom: 0;">
                                        <strong>
