...
public partial class PresentationLayer_TCS_TCS_HTML_S_3_8_B_201920 : System.Web.UI.Page
{
    ...
    public void LoadReport()
    {
        try
        {
            ...
            if (dt.Rows.Count > 0)
                ViewState["Class_Id"] = dt.Rows[0]["Class_Id"];
    ...
    protected void Reptr_Student_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        ...
        try
        {
                ...
                (item.ItemType == ListItemType.AlternatingItem))
            {
                ...
                Repeater4.DataBind();
                if (Convert.ToInt32(ViewState["Class_Id"].ToString()) == 10)
                {
                    HtmlControl lblPromoted = e.Item.FindControl("Div4") as HtmlControl;

                    if (lblPromoted != null)
                        lblPromoted.Attributes.Add("style", "margin-left: 70px; padding-top: 85px");
                }
                if (Convert.ToInt32(ViewState["Class_Id"].ToString()) >= 11 && Convert.ToInt32(ViewState["Class_Id"].ToString()) <= 12)
                {

                    HtmlControl lblPromoted = e.Item.FindControl("Div4") as HtmlControl;

                    if (lblPromoted != null)
                        lblPromoted.Attributes.Add("style", "margin-left: 70px; padding-top: 105px");
                }
            }
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        pdfBulkExport.ExportBulkPdf(Section,Sess,Term,Student, "~/PDFFiles/ResultCard.pdf");
    }
}