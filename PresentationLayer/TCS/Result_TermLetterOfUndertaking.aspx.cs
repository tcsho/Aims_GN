...
public partial class PresentationLayer_TCS_Result_TermLetterOfUndertaking : System.Web.UI.Page
{
    ...
    protected void btnViewReport_Click(object sender, EventArgs e)
    {
        ...
        {
            ActualReportCalling();
            ////// Comment on 5 April 2016 for letter of undertaking
            //////////HTMLReportCalling();
        }
        catch (Exception ex)
        {
                        ...
                        if (dtUndTkCheck.Rows.Count <= 0)
                        {
                            ...
                            else if (class_Id >= 7 && class_Id <= 12) // Class 3-8
                            {
                                if (termGroup_Id == 1)
                                {
                                    ...
                                    {
                                        /*WithBorder*/
                                        //Response.Redirect("~/PresentationLayer/TCS/TCS_HTML_F_3_8_B.aspx"+Qs, false);
                                        url = "TCS_HTML_F_3_8_B.aspx" + Qs;
                                    }
                                    else
                                    {
                                        /*Without Border*/
                                        //Response.Redirect("~/PresentationLayer/TCS/TCS_HTML_F_3_8.aspx" + Qs, false);
                            ...
                            else if (class_Id >= 13 && class_Id <= 15) // O Level
                            {
                                ...
                                if (termGroup_Id == 1)
                                {
                                    ...
                                    {
                                        /*WithBorder*/
                                        //Response.Redirect("~/PresentationLayer/TCS/TCS_HTML_F_O_A_B.aspx" + Qs, false);
                                        url = "TCS_HTML_F_O_A_B.aspx" + Qs;
                                    }
                                    else
                                    {
                                        /*Without Border*/
                                        //Response.Redirect("~/PresentationLayer/TCS/TCS_HTML_F_O_A.aspx" + Qs, false);
