<%@ Page Title="" Language="C#" MasterPageFile="~/PresentationLayer/MasterPage.master"
    AutoEventWireup="true" CodeFile="LmsResource.aspx.cs" Inherits="PresentationLayer_LmsResource" %>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td id="tdFrmHeading" class="formheading">
                                            <asp:Label ID="Label1" CssClass="lblFormHead" runat="server" Text="LMS Resource"></asp:Label>
