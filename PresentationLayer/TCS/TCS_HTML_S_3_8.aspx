<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TCS_HTML_S_3_8.aspx.cs" Inherits="PresentationLayer_TCS_TCS_HTML_S_3_8" %>
...
<body style="">
    ...
    <asp:Repeater ID="Reptr_Student" runat="server" OnItemDataBound="Reptr_Student_ItemDataBound">
                        ...
                        <div id="city-school-header-text" style="font-family: Arial; line-height: 0.5; text-align:center;padding-left:90px;padding-right:90px;">
                            <h3 style="font-weight: lighter;">
                                <br>
                                    ...
                                    End of Year Examination <%#Eval("SessionCode") %>
                            </h3>
     ...
     <div id="student-credentials" style="width: 97%;">
                ...
                <div id="performance-indicators" style="padding-top: 15px; padding-bottom: 5px;
                    text-align: center; width: 100%;">
                    <p>
                        <strong>PERFORMANCE INDICATORS</strong></p>
                </div>
                <div id="performance-indicators-table" style="margin-left: 10px; padding-top: 10px;
                    padding-bottom: 5px; padding-left: 20px; padding-right: 20px; width: 92%;
               ...
               <div id="Div3" style="margin-left:70px;padding-top:130px">
                <p style="padding-right:100px">
                  ...
                  <p id="P1" runat="server" style="padding-left: 25px; padding-top: 20px; bottom: 0;"
                   visible='<%#(Eval("Region_Id").ToString() == "2000000")?false:true%>'><strong>Date: 2<sup>nd</sup> June 2017.</strong>
                  </p>

                  <p id="P2" runat="server" style="padding-left: 25px; padding-top: 20px; bottom: 0;"
                   visible='<%#(Eval("Region_Id").ToString() == "2000000")?true:false%>'><strong>Date: 2<sup>nd</sup> June 2017.</strong>
                  </p>
...
<%--                <script type="text/javascript">
 ...
 <%--       <div id="UnderTakingSimple" runat="server" style="width: 900px; height: 1310px; padding: 10px; border: 0px solid blue;
                display: inline-block;position:relative;" visible='<%#(Eval("isPromoted").ToString() == "False" && Eval("Cond_Prom").ToString().Length < 1)?true:false%>'>
...
<div id="Div18" style="float:left;">
                  <p id="P6" runat="server" style="padding-left: 25px;"
...
style='font:7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span></span></b><span
style='color:black'>That it is essential for him/her to improve his/her performance and show the minimum required standards in the next academic year. I understand that the Annual Result includes result of the Mid-year exams and the End-of-year exams.</span></p>
...
style='font:7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span></span></b><span
style='color:black'>I have received information from the school regarding the minimum standards required for promotion to next class.</span></p>
...
<%--        <div id="UnertakingLetterPromotion" runat="server" style="width: 900px; height: 1310px; padding: 10px; border: 0px solid blue;
                display: inline-block;position:relative;" visible='<%#(Eval("isPromoted").ToString() == "False" && Eval("Cond_Prom").ToString().Length >= 1 )?true:false%>'>                <!--//////////////////////////////////////-->
                <!-- This div is for main logo and header tilte-->
...
<p align="center" style='text-align:center'><b><span
style='font-size:18.0pt;font-family:"Calibri",sans-serif;color:#990000'>Discretionary Promotion</span></b></p>
...
justify;text-indent:-.25in;line-height:normal'><b><span style='color:black'>2)<span
style='font:7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span></span></b><span
style='color:black'>However, I have shown cause for this below-par achievement and, on my assertion and persistent request, the school has conditionally allowed my child promotion to the next class. I understand that this provision is available only once and I will not be able to seek it again.</span></p>
...
<p style='margin-bottom:12.0pt;text-align:
justify;text-indent:-.25in;line-height:normal'><b><span style='color:black'>4)<span
style='font:7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span></span></b><span
style='color:black'>I have received information from the school regarding the minimum standards required for passing.</span></p>
