...
AutoEventWireup="true" CodeFile="StudentScheduleTest.aspx.cs" 
Inherits="PresentationLayer_TCS_StudentScheduleTest"     
Theme="BlueTheme" %>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td id="tdFrmHeading" class="formheading">
                                            <asp:Label ID="Label1" CssClass="lblFormHead" runat="server" Text="Class Tests"></asp:Label>
                    ...
                    <tr>
                        <td>
                            <table class="main_table" cellspacing="0" cellpadding="0" width="100%" align="center"
                                border="0">
                                <tr style="width: 100%">
                                    <td align="right" colspan="1" class="TextLabelMandatory">
                                        Class Section*:
                                    </td>
                                ...
                                <tr style="width: 100%">
                                    <td align="right" colspan="1" class="TextLabel">
                                        Student:
                                    </td>
                                    <td align="left" style="width: 60%">
