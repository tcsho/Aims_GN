<%@ Page Title="" Language="C#" MasterPageFile="~/PresentationLayer/MasterPage.master"
    AutoEventWireup="true" CodeFile="LMSPollsSubmission.aspx.cs" Inherits="PresentationLayer_TCS_LMSPollsSubmission" %>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td id="tdFrmHeading" class="formheading">
                                            <asp:Label ID="Label1" CssClass="lblFormHead" runat="server" Text="Student's Polls Submission"></asp:Label>
                            ...
                            <table class="main_table" cellspacing="0" cellpadding="0" width="100%" align="center"
                                ...
                                <tr style="width: 100%">
                                    ...
                                    <td style="width: 60%" align="left">
                                        <asp:DropDownList ID="List_Poll" runat="server" AutoPostBack="True" CssClass="dropdownlist"
                                ...
                                <tr style="width: 100%">
                                    <td align="left" style="width: 100%; text-align: center" colspan="2">
                                        <asp:GridView ID="gvPollQuestion" runat="server" AutoGenerateColumns="False" BorderStyle="None"
                                            OnRowDataBound="gvSubjects_RowDataBound" Width="100%" OnSorting="gvSubjects_Sorting"
                                            OnRowCommand="gvSubjects_RowCommand">
                                            <AlternatingRowStyle CssClass="tr2" />
                                            <Columns>
                                                <asp:BoundField DataField="Poll_ID" SortExpression="Poll_ID" 
                                                    HeaderText="Poll_ID">
                                                    <ItemStyle CssClass="hide" />
                                                    <HeaderStyle CssClass="hide" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="PollDetail_ID" 
                                                    HeaderText="PollDetail_ID">
                                                     <HeaderStyle CssClass="hide" />
                                                    <ItemStyle CssClass="hide" />
                                                </asp:BoundField>
                                                ...
                                                <asp:BoundField DataField="LmsPollsSubmissionsUser_ID" 
                                                    HeaderText="LmsPollsSubmissionsUser_ID" HeaderStyle-CssClass = "hide" ItemStyle-CssClass = "hide" />
                                                ...
                                                <asp:TemplateField HeaderText="Copy">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="btnEdit" runat="server" ForeColor="#004999" OnClick="btnCopy_Click"
                                                            ...
                                                            CommandArgument='<%# Eval("Poll_ID") %>'></asp:ImageButton>
                                                    </ItemTemplate>
