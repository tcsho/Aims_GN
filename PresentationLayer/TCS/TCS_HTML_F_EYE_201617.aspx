<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TCS_HTML_F_EYE_201617.aspx.cs"
    Inherits="PresentationLayer_TCS_TCS_HTML_F_EYE_201617" %>
        ...
        <asp:Repeater ID="Reptr_Student" runat="server" OnItemDataBound="Reptr_Student_ItemDataBound">
            <ItemTemplate>
                ...
                <div id="blue_border" style="background-color: white; width: 900px; padding: 10px; border: 4px solid #fff; display: inline-block;">
                                        ...
                                        <asp:Repeater ID="GenPerKeys" runat="server" OnItemDataBound="Reptr_GP_ItemDataBound">
                                            ...
                                            <ItemTemplate>
                                                <tr id="pecrItem" runat="server" style="width: 100%; height: 28px; border-top-width: 0; border-left-width: 0; border-right-width: 0;">
                                                    <td id="GKLO" runat="server" style="text-align: left; width: 36.5%; padding-left: 5px;padding-right: 3px; border-width: 0; text-align: left; font-size: 13px;">
                                                        <%#Eval("KLO")%>
                                                    </td>
                                                    <td style="text-align: center; width: 10%; border-top-width: 0; border-right-width: 0; border-bottom-width: 0;">
                                ...
                                <tr id="pagebreak" runat="server">
                                    ...
                                    <td colspan="5" style="border-bottom-width: 0">
                                        <asp:Repeater ID="GenPerKeys1" runat="server" OnItemDataBound="Reptr_GP1_ItemDataBound">
                                            ...
                                            <ItemTemplate>
                                                <tr id="pecrItem" runat="server" style="width: 100%; height: 28px; border-top-width: 0; border-left-width: 0; border-right-width: 0;">
                                                    <td id="GKLO1" runat="server" style="text-align: left; width: 38.8%; padding-left: 5px;padding-right: 3px; border-width: 0; font-size: 13px;">
                                                        <%#Eval("KLO")%>
                                                    </td>
                    ...
                    <div id="DateOld" runat="server" visible='<%#(Convert.ToInt32(Eval("Session_Id").ToString()) <= 9)?true:false%>'>
                        <p id="P3" style="padding-left: 15px; padding-top: 20px; bottom: 0;">
                            <strong>Date: 22<sup>nd</sup> December 2017.</strong>
                        </p>
                        </p>
                    </div>

                    <div id="DateNew" runat="server" visible='<%#(Convert.ToInt32(Eval("Session_Id").ToString()) == 9)?true:false%>'>

                        <p id="P2" runat="server" style="padding-left: 15px; padding-top: 20px; bottom: 0;">
                            <strong>Date: 24<sup>th</sup> December 2018.</strong>
                        </p>
                    </div>
                     <div id="Div3" runat="server" visible='<%#(Convert.ToInt32(Eval("Session_Id").ToString()) > 9)?true:false%>'>

                        <p id="P1" runat="server" style="padding-left: 15px; padding-top: 20px; bottom: 0;">
                            <strong> <asp:Label ID="lblResultDate" runat="server"></asp:Label></strong>
                        </p>
                    </div>
                   

                    <div runat="server" id="Div12" style="padding-top: 10px; padding-left: 10px; padding-bottom: 0px;" visible='<%#(Convert.ToInt32(Eval("Session_Id").ToString()) <= 9)?true:false%>'>
                        <p>
                            <strong>PERFORMANCE INDICATORS</strong>
                        </p>
                        <p>
                            <strong>Exceeding Development: </strong><span style="margin-left: 10px;">Your child
                            is working above the expected level.</span>
                        </p>
                        <p>
                            <strong>Expected Development: </strong><span style="margin-left: 19px;">Your child is
                            working at the expected level .</span>
                        </p>
                        <p>
                            <strong>Emerging Development: </strong><span style="margin-left: 17px;">Your child is
                            working below the expected level.</span>
                        </p>
                        <p>
                            <strong>Needs Improvement: </strong><span style="margin-left: 42px;">Experiencing difficulty
                            requires continuous assistance.</span>
                        </p>
                    </div>
                    <div id="Div2" runat="server" style="padding-top: 10px; padding-left: 10px; padding-bottom: 0px;" visible='<%#(Convert.ToInt32(Eval("Session_Id").ToString()) > 9)?true:false%>'>
                        <p>
                            <strong>PERFORMANCE INDICATORS</strong>
                        </p>
                        <p>
