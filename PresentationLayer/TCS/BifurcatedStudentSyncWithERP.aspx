<%@ Page Title="" Language="C#" MasterPageFile="~/PresentationLayer/MasterPage.master"
    AutoEventWireup="true" CodeFile="BifurcatedStudentSyncWithERP.aspx.cs"
    Inherits="PresentationLayer_BifurcatedStudentSyncWithERP" %>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td id="tdFrmHeading" class="formheading">
                                            <asp:Label ID="Label1" CssClass="lblFormHead" runat="server" Text="Bifurcated Students Sync With ERP "></asp:Label>
                                ...
                                <tr style="width: 50%">
                                    ...
                                    <td align="left" style="width: 60%">
                                        <asp:DropDownList ID="ddlClass" runat="server" AutoPostBack="True" CssClass="dropdownlist"
                                            OnSelectedIndexChanged="ddlClass_SelectedIndexChanged" Width="218px" Enabled="false">
                                        </asp:DropDownList>
                                    </td>
                                </tr>
                                <tr style="width: 50%">
