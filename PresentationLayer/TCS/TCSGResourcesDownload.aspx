<%@ Page Title="" Language="C#" MasterPageFile="~/PresentationLayer/MasterPage.master"
    AutoEventWireup="true" CodeFile="TCSGResourcesDownload.aspx.cs" Inherits="PresentationLayer_TCS_TCSGResourcesDownload"
    Theme="BlueTheme" %>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td id="tdFrmHeading" class="formheading">
                                            <asp:Label ID="Label2" CssClass="lblFormHead" runat="server" Text="Download Academic Resource"></asp:Label>
                                ...
                                <td style="width: 100%" align="center">
                                    <table cellspacing="0" cellpadding="0" border="0">
                                        ...
                                        <%--                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:DropDownList ID="ddlSession" runat="server" CssClass="dropdownlist" Width="180px" Enabled="false">
                                                        </asp:DropDownList>
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ErrorMessage="Session is required"
                                            ...
                                            <asp:TemplateField HeaderText="Resource Catagory">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btnResCat" runat="server" ForeColor="#004999" OnClick="btnResCat_Click"
                                                        ValidationGroup="s" Style="text-align: center; font-weight: normal;" Text='<%# Eval("GResourceCatDesc") %>  '
                                                        ToolTip="View this Record" CommandArgument='<%# Eval("GResourceCat_ID") %>'></asp:LinkButton>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:BoundField DataField="ResourceTitle" HeaderText="Resource Title"></asp:BoundField>
                                        </Columns>
