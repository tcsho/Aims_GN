...
using System.Data;
public partial class PresentationLayer_TCS_TCS_HTML_S_O_A_B : System.Web.UI.Page
{
    ...
    public void LoadReport()
    {
        try
        {
            ...
            DataTable DistinctStudent = dv.ToTable(true, "Student_No", "Student_Id", "StudentName", "Class_Name", "Section_Name", "Strength", "DaysPresent", "Student_Age", "Class_Avg_Age", "Overall_P", "Class_Heighest", "Class_Average", "Overall_G", "ClassTeacher_Comments", "SecondTermDaysCH", "Main_Organisation_Name", "Evaluation_Criteria_Type_Name", "Center_Name", "PromotedToClass", "TtlAct");
