<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TCS_HTML_S_EYE_B.aspx.cs" Inherits="PresentationLayer_TCS_TCS_HTML_S_EYE_B" %>
...
<head>
    ...
    <style id="Style2" type="text/css" media="print" runat="server">
        div.page {
...
(<%#Eval("Type") %>)                                   
                    ...
                    <div id="divPage1" runat="server">
                        <asp:Repeater ID="GenPer1" runat="server" OnItemDataBound="Reptr_Subject1_ItemDataBound">
                            <HeaderTemplate>
                                <table style="width: 97%; height: auto; margin-left: 10px; border: none;">
                                    <tr>
                                        <td width="9%" style="text-align: left; padding-left: 10px;"></td>
                                        <td width="51%"></td>
                                        <td width="4%"></td>
                                        <td width="4%"></td>
                                        <td width="4%"></td>
                    ...
                    <p id="P1" runat="server" style="padding-left: 15px; padding-top: 20px; bottom: 0;"
                        visible='<%#(Eval("SessionCode").ToString() == "2014-2015")?true:false%>'>
                        <strong>Date: 6<sup>th</sup> June <%# Eval("SessionCode").ToString().Length > 4 ?
    Eval("SessionCode").ToString().Substring(Eval("SessionCode").ToString().Length - 4, 4)
   :Eval("SessionCode").ToString() %>.</strong>
                    </p>
