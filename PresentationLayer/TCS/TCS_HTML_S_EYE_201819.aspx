<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TCS_HTML_S_EYE_201819.aspx.cs" Inherits="PresentationLayer_TCS_TCS_HTML_S_EYE_201718" %>
            ...
            <ItemTemplate>
                ...
                <div id="blue_border" style="background-color: white; width: 900px; padding: 10px; border: 4px solid #fff; display: inline-block;">
                                        ...
                                        <asp:Repeater ID="GenPerKeys" runat="server" OnItemDataBound="Reptr_GP_ItemDataBound">
                                            ...
                                            <ItemTemplate>
                                                <tr id="pecrItem" runat="server" style="width: 100%; height: 28px; border-top-width: 0; border-left-width: 0; border-right-width: 0;">
                                                    <td id="GKLO" runat="server" style="text-align: left; width: 38.5%; padding-left: 5px; border-width: 0; text-align: left; font-size: 13px;">
                                                        <%#Eval("KLO")%>
                                                    </td>
                                ...
                                <tr id="pagebreak" runat="server">
                                    ...
                                    <td colspan="5" style="border-bottom-width: 0">
                                        <asp:Repeater ID="GenPerKeys1" runat="server" OnItemDataBound="Reptr_GP1_ItemDataBound">
                                            ...
                                            <ItemTemplate>
                                                <tr id="pecrItem" runat="server" style="width: 100%; height: 28px; border-top-width: 0; border-left-width: 0; border-right-width: 0;">
                                                    <td id="GKLO1" runat="server" style="text-align: left; width: 38.5%; padding-left: 5px; border-width: 0; font-size: 13px;">
                                                        <%#Eval("KLO")%>
                                                    </td>
                                                    <td style="text-align: center; width: 10.1%; border-top-width: 0; border-right-width: 0; border-bottom-width: 0;">
                                                        <%#Eval("Key3").ToString()=="True" ?"&#10004;":""%>
                    ...
                    <div id="divPage2" runat="server">
                        <asp:Repeater ID="GenPer2" runat="server" OnItemDataBound="Reptr_Subject1_ItemDataBound">
                            <HeaderTemplate>
                                <table style="width: 100%; height: auto; margin-left: 10px; border: none;">
                                    <tr>
                                        <td width="13%" style="text-align: left; padding-left: 10px;">
                    ...
                    <p style="padding-left: 15px;padding-top: 50px; bottom: 0;">
...
<%--                    <p id="P1" runat="server" style="padding-left: 15px; padding-top: 5px; bottom: 0; ">
                    ...
                    <p id="P120" runat="server" style="padding-left: 15px; padding-top: 20px; bottom: 0;">
                             <strong>Date: 24<sup>th</sup> December 2017.</strong>
                    </p>
