<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TCS_HTML_F_EYE_201617_B.aspx.cs"
    Inherits="PresentationLayer_TCS_TCS_HTML_F_EYE_201617_B" %>
...
<body style="">
    ...
    <asp:Repeater ID="Reptr_Student" runat="server" OnItemDataBound="Reptr_Student_ItemDataBound">
        <ItemTemplate>
            ...
            <div id="blue_border" style="background-color: white; width: 900px; padding: 10px;
                border: 4px solid #fff; display: inline-block;">
                <!--//////////////////////////////////////-->
                        ...
                        <div id="student-credentials-column-left" style="width: 40%; float: left; padding-left: 20px;">
                            <div id="column1-left" style="float: left; width: 100%;">
                                ...
                                <p>
                                    ...
                                    <p>
                                        Total working days:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%#Eval("FirstTermDaysCH")%></p>
                            </div>
                        </div>
                ...
                <div id="city-school-Kyes" style="padding-top: 90px; padding-left: 10px; padding-bottom: 5px;color:White">
                   <p>
                            ...
                            <tr id="pagebreak" runat="server">
                                ...
                                <td colspan="5" style="border-bottom-width: 0; width: 67%">
                                    <asp:Repeater ID="GenPerKeys" runat="server" OnItemDataBound="Reptr_GP_ItemDataBound">
                                        ...
                                        <ItemTemplate>
                                            <tr id="pecrItem" runat="server" style="width: 100%; height: 28px; border-top-width: 0;
                                                border-left-width: 0; border-right-width: 0;">
                                                <td id="GKLO" runat="server" style="text-align: left; width: 38.8%; padding-left: 5px;
                                                    border-width: 0; text-align: left;font-size: 13px;">
                                                    <%#Eval("KLO")%>
                                                </td>
                                                <td style="text-align: center; width: 10.1%; border-top-width: 0; border-right-width: 0;
                                                ...
                                                <td style="text-align: center; width: 9.9%; border-top-width: 0; border-right-width: 0;
                                                    border-bottom-width: 0;">
                                ...
                                <td colspan="5" style="border-bottom-width: 0">
                                    <asp:Repeater ID="GenPerKeys1" runat="server" OnItemDataBound="Reptr_GP1_ItemDataBound">
                                        ...
                                        <ItemTemplate>
                                            <tr id="pecrItem" runat="server" style="width: 100%; height: 28px; border-top-width: 0;
                                                border-left-width: 0; border-right-width: 0;">
                                                <td id="GKLO1" runat="server" style="text-align: left; width: 38.8%; padding-left: 5px;
                                                    border-width: 0;font-size:13px;">
                                                    <%#Eval("KLO")%>
                                                </td>
                                                <td style="text-align: center; width: 10.1%; border-top-width: 0; border-right-width: 0;
                                                    border-bottom-width: 0;">
                ...
                <p style="padding-top: 10px; bottom: 0;">
                    <strong>*This is a system generated report and does not require any signature and stamp.</strong></p>
                ...
                <p id="P4" runat="server" style="padding-left: 15px; padding-top: 20px; bottom: 0;"
                    ...
                    <strong>Date: 22<sup>nd</sup> December 2017.</strong>
                                ...
                                <div id="Div2" style="padding-top: 10px; padding-left: 10px; padding-bottom: 0px;">
                    <p>
