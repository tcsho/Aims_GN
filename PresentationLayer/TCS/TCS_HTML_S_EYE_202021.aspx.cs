...
public partial class PresentationLayer_TCS_TCS_HTML_S_EYE202021 : System.Web.UI.Page
{
 ...
 where row.Field<int>("Student_Status_Id") != 9
        ...
        { 
                    ...
                    { 
                        ...
                        else if (class_id == 3) //Class Nursery
                        {
                            if (i < 6)
                            {
                                ...
                                if (divControl != null)
                                {
                                    divControl.Style.Add(HtmlTextWriterStyle.PaddingTop, "240px");
                                }
                            }
                            else
                            {
                        ...
                        else if (class_id == 6) //Class Class -2 
                        {
                            if (i >= 1 && i <= 3)
                            {
                                ...
                                HtmlGenericControl divControl1 = e.Item.FindControl("divPage1") as HtmlGenericControl;
                                if (divControl1 != null)
                                {
                                    divControl1.Style.Add(HtmlTextWriterStyle.PaddingTop, "225px");
                                }
                            ...
                            else
                            {
                                ...
                                if (divControl1 != null)
                                {
                                    divControl1.Style.Add(HtmlTextWriterStyle.PaddingTop, "350px");
                                }
                            }
                        }
                        else
            ...
            if (DistinctResultDate.Rows.Count > 0)
            {
                ...
                if (textbox != null)
                {
                    ...
                    if (DistinctResultDate.Rows[0]["ResultDate"].ToString() == "Result issuance Date is not defined")
                    {
                        textbox.Text = DistinctResultDate.Rows[0]["ResultDate"].ToString();
                    }
                    else
                    {
    ...
    private void UrduSubjectSettings(RepeaterItemEventArgs e)
    {
            ...
            (item.ItemType == ListItemType.AlternatingItem))
        {
            ...
            if (ViewState["Subject_Id"].ToString() == "114" || ViewState["Subject_Id"].ToString() == "123" || ViewState["Subject_Id"].ToString() == "12" || ViewState["Subject_Id"].ToString() == "61" || ViewState["Subject_Id"].ToString() == "17")
            {
