...
public partial class PresentationLayer_TCS_LmsSurvey : System.Web.UI.Page
{
    ...
    private void BindGrid()
    {
        try
        {
        BLLLmsSurvey objClsSec = new BLLLmsSurvey();
        ...
        {
            dtsub = (DataTable)objClsSec.LmsSurveySelectAllBySectionSubjectIdWrkToolId(objClsSec);
        }
        else
        {
    ...
    private void BindGridQuestionDetail()
    {
        ...
        try
        {
        BLLLmsSurveyDetail objClsSec = new BLLLmsSurveyDetail();
        ...
        objClsSec.Survey_ID = Convert.ToInt32(ViewState["QuestionReferenceId"]);
        ////////objClsSec.WrkTool_ID = Convert.ToInt32(Session["WorkToolId"].ToString());
        ...
        if (ViewState["dtDetails"] == null)
        {
            dtsub = (DataTable)objClsSec.LmsSurveyDetailSelectAllBySurveyId(objClsSec);
        }
        else
        {
            dtsub = (DataTable)ViewState["dtDetails"];
    ...
    private void BindGridQuestionOption()
    {
        try
        {
        BLLLmsSurveyQuestionDetailOption objClsSec = new BLLLmsSurveyQuestionDetailOption();
        ...
        if (ViewState["dtDetails"] == null)
        {
            dtsub = (DataTable)objClsSec.LmsSurveyQuestionDetailOptionFetch(objClsSec);
        }
        else
        {
            dtsub = (DataTable)ViewState["dtDetails"];
    ...
    protected void but_save_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (mode != "Edit")
            {
                ...
                AlreadyIn = objClsSec.LmsSurveyAdd(objClsSec);
            ...
            else
            {
                ...
                objClsSec.Survey_ID = Convert.ToInt32(ViewState["ReferenceId"]);
                objClsSec.ModifiedBy = Convert.ToInt32(Session["ContactID"].ToString());
                objClsSec.ModifiedOn = DateTime.Now;

                AlreadyIn = objClsSec.LmsSurveyUpdate(objClsSec);
    ...
    protected void btnEdit_Click(object sender, ImageClickEventArgs e)
    {
        ...
        objClsSec.Survey_ID = Convert.ToInt32(ReferenceIdValue);


        dtsub = (DataTable)objClsSec.LmsSurveySelectAllBySurveyId(objClsSec);
    ...
    protected void btnDelete_Click(object sender, ImageClickEventArgs e)
    {
        ...
        AlreadyIn = objClsSec.LmsSurveyDelete(objClsSec);
    ...
    protected void btnQuestionSave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (mode != "Edit")
            {
                    ...
                    AlreadyIn = objClsSec.LmsSurveyDetailAdd(objClsSec);
                ///// without it 
                    //////////AddQuestionDetail();
                    ...
                    if (AlreadyIn == 0)
                    {
                        ImpromptuHelper.ShowPrompt("Question was successfully added to this Survey.");
                        pan_new2.Attributes.CssStyle.Add("display", "none");
                        pan_QestGrid.Attributes.CssStyle.Add("display", "inline");
                        BindGridQuestionDetail();
            ...
            {
                objClsSec.SurveyDetail_ID = Convert.ToInt32(ViewState["QuestionDetailId"]);



                AlreadyIn = objClsSec.LmsSurveyDetailUpdate(objClsSec);


                ViewState["dtDetails"] = null;
                if (AlreadyIn == 0)
                {
                    ImpromptuHelper.ShowPrompt("Question was successfully updated to this Survey.");
                    pan_new2.Attributes.CssStyle.Add("display", "none");
                    pan_QestGrid.Attributes.CssStyle.Add("display", "inline");
                    BindGridQuestionDetail();
    ...
    protected void btnQuestionDTEdit_Click(object sender, EventArgs e)
    {
        ...
        dtsub = (DataTable)objClsSec.LmsSurveyDetailSelectAllBySurveyDetailID(objClsSec);
