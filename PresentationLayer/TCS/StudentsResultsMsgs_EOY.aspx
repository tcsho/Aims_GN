<%@ Page Language="C#" MasterPageFile="~/PresentationLayer/MasterPage.master" AutoEventWireup="true" CodeFile="StudentsResultsMsgs_EOY.aspx.cs" Inherits="PresentationLayer_TCS_StudentsResultsMsgs_EOY" %>
        ...
        <ContentTemplate>
            ...
            <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12 form-group ">
                ...
                <%--  <asp:Label ID="Label4" runat="server" CssClass="col-lg-6 col-md-6 col-sm-6 col-xs-12 TextLabel40"
                    Text="Report Name : "></asp:Label>--%>
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <asp:DropDownList CssClass="dropdownlist" runat="server" ID="ddlrptname" OnSelectedIndexChanged="ddlrptname_SelectedIndexChanged" AutoPostBack="true" Width="250px">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-group">
                <asp:GridView ID="Grid_IEPStudents" runat="server" AutoGenerateColumns="False" OnRowCommand="Grid_IEPStudents_RowCommand" CssClass="datatable table table-bordered table-condensed"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField HeaderText="Is Fee Defaulter" DataField="isFeeDefaulter" />
                        <asp:TemplateField HeaderText="View Result" ItemStyle-Width="150" SortExpression="1">
                            <ItemTemplate>
                                <asp:Button runat="server" ID="txt_view" CommandName="View" Text="View" CommandArgument='<%#Eval("URL")%>'  />
                            </ItemTemplate>
