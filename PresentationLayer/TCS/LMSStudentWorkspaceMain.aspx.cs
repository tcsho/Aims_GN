...
public partial class PresentationLayer_LMSStudentWorkspaceMain : System.Web.UI.Page
{
    ...
    private void BindGrid()
    {
        try
        {
            ...
            objClsSec.Student_Id = Int32.Parse(Session["ContactID"].ToString());
                ...
                dtsub = objClsSec.Section_SubjectSelectAllWorkSiteByStudentId(objClsSec);
