...
public partial class PresentationLayer_StudentCriteriaMarksET : System.Web.UI.Page
{
    ...
    private void BindGrid(bool doOverride)
    {
        ...
        try
        {
            ...
            if (list_Term.SelectedIndex > 0 && list_Subject.SelectedIndex > 0 && list_EvlType.SelectedIndex > 0)
            {
                ...
                ds = DALBase.getDataSetBySp("Student_Evaluation_CriteriaETBySectionSubjectId", param);
                ...
                DataSet lockMarkDs = DALBase.getDataSetBySp("Student_Evaluation_CriteriaETBySectionSubjectIdMarksLock", param);
