<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TCS_HTML_B.aspx.cs" Inherits="PresentationLayer_TCS_TCS_HTML_B" %>
...
<body style="">
    ...
    <asp:Repeater ID="Reptr_Student" runat="server" OnItemDataBound="Reptr_Student_ItemDataBound">
        <ItemTemplate>
            ...
            <div id="blue_border" style=" width:900px;height:1310px;padding:10px;border:1px solid blue;display: inline-block;">
