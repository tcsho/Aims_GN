...
public partial class PresentationLayer_TCS_Previous_IEP : System.Web.UI.Page
{
    ...
    private void loadRegions()
    {
        try
        {
            ...
            if ((Convert.ToInt32(row["User_Type_Id"].ToString()) == 3) || (Convert.ToInt32(row["User_Type_Id"].ToString()) == 4))
            {
    ...
    {
        DataTable dt_class = exec_SP(ddl_center.SelectedItem.Value, ddlClass.SelectedItem.Value, ddlieptype.SelectedItem.Text);
