...
public partial class PresentationLayer_TCS_TCS_HTML_F_3_8_B_201920 : System.Web.UI.Page
{
    ...
    protected void Reptr_Student_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        ...
        try
        {
            ...
            if (DistinctResultDate.Rows.Count > 0)
            {
                ...
                Label lblUndertakeDate = item.FindControl("UndertakeDate") as Label;
                Label lblIntimateDate = item.FindControl("IntimateDate") as Label;
                if (textbox != null)
                {
                    ...
                    if (!String.IsNullOrEmpty(DistinctResultDate.Rows[0]["ResultDate"].ToString()))
                    {
                        ...
                        lblIntimateDate.Text = textbox.Text;
                        lblUndertakeDate.Text = textbox.Text;
                    }
                }
            }
        }
