...
public partial class PresentationLayer_TCS_Result_Term_New : System.Web.UI.Page
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            int termId = Int32.Parse(ddlTerm.SelectedValue.ToString());

            int termGroup_Id;

            if (ddl_center.SelectedIndex > 0 && ddlSession.SelectedIndex > 0 && ddlTerm.SelectedIndex > 0)
            {
                ...
                AlreadyIn = objClsSec.TCS_Result_GenerateResultAllBySection_Id_New(objClsSec);
                ImpromptuHelper.ShowPrompt("Result Calculation Generated Successfully!");
            }
            else
            {
                ImpromptuHelper.ShowPrompt("Please select Center, Session and Term!");
            }
        }
