<%@ Page Title="" Language="C#" MasterPageFile="~/PresentationLayer/MasterPage.master"
    AutoEventWireup="true" CodeFile="LMSWorkSiteToolAssignment.aspx.cs" Inherits="PresentationLayer_LMSWorkSiteToolAssignment" %>
                                ...
                                <tr style="width: 100%">
                                    ...
                                    <td style="width: 60%" align="left">
                                        ...
                                        <asp:RequiredFieldValidator ForColor="Red" ID="RequiredFieldValidator1" runat="server"
                                                Display="None" ValidationGroup="c" ErrorMessage="Select Class and Section" ControlToValidate="List_ClassSection"
                       ...
                       Font-Bold="False" ValidationGroup="btnNew">Assign Selected Work Site Tool</asp:LinkButton></td>
                                ...
                                <tr style="width: 100%">
                                    <td align="left" style="width: 100%; text-align: center" colspan="2">
                                        <asp:GridView ID="gvDetail" runat="server" AutoGenerateColumns="False" BorderStyle="None"
                                ...
                                <tr style="width: 100%">
                                    <td align="left" style="width: 100%; text-align: center" colspan="2">
                                        <asp:GridView ID="gvAssign" runat="server" AutoGenerateColumns="False" BorderStyle="None" Width="100%"  >
                                            <AlternatingRowStyle CssClass="tr2" />
                                            <Columns>
