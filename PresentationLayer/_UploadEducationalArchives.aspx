<%@ Page Language="C#" MasterPageFile="~/PresentationLayer/MasterPage.master" AutoEventWireup="true" CodeFile="_UploadEducationalArchives.aspx.cs" Inherits="PresentationLayer_UploadEducationalArchives"
    Theme="BlueTheme" %>
                ...
                <tbody>
                    <tr>
                        ...
                        <td id="tdFrmHeading" class="formheading">
                            <asp:Label ID="Label3" CssClass="lblFormHead" runat="server" Text="Upload Educational Archives"></asp:Label>
                    ...
                    <td style="vertical-align: top">
                        <table cellspacing="0" cellpadding="0" width="100%" align="center" border="0">
                            ...
                            <tr id="FileUploadGrid" runat="server" visible="false">
                                ...
                                <td>
                                    <asp:Button ID="btnSampleFile" class="button" runat="server" OnClick="btnsample_Click" Text="Download Sample File" Visible="true" />
