<%@ Page Title="" Language="C#" MasterPageFile="~/PresentationLayer/MasterPage.master"
    AutoEventWireup="true" CodeFile="EvaluationCriteriaPercentage.aspx.cs" Inherits="PresentationLayer_EvaluationCriteriaPercentage" %>
            ...
            <table class="main_table" cellspacing="0" cellpadding="0" width="100%" align="center"
                ...
                <tbody>
                    <tr>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td id="tdFrmHeading" class="formheading">
                                            <asp:Label ID="Label1" CssClass="lblFormHead" runat="server" Text="Term Evaluation Criteria Percentage"></asp:Label>
                       ...
                       Font-Bold="False" ValidationGroup="btnNew">Add New Criteria</asp:LinkButton></td>
                                    </td>
                                </tr>
                                <tr style="width: 100%">
                                            ...
                                            <td>
                                                <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width: 510px; height: 25px" class="tr1">
                                                            <asp:TextBox ID="txtGrade" runat="server"></asp:TextBox>
                                                             <asp:CompareValidator ID="CompareValidator2" ControlToValidate="txtGrade" runat="server" ErrorMessage="Please Enter Only Integer Values" Operator="DataTypeCheck" Type ="Integer"></asp:CompareValidator>
                                                        </td>
                                                    ...
                                                    <tr>
                                                     ...
                                                     <tr style="width: 100%">
                                                      <td class="tr1" style="width: 8px; height: 18px">
                                                            &nbsp;</td>
                                    <td class="tr1" style="height: 26px; width: 40%; text-align: right" align="right" colspan="1">
                                        Subject :
                                    </td>
                                    <td  class="tr1"style="width: 60%" align="left">
                        ...
                        CssClass="datatable table table-striped table-responsive"
                                EmptyDataText="No Record Exists." OnPreRender="gvSubjects_PreRender" >
                                            ...
                                            <Columns>
                                                <asp:BoundField DataField="Evaluation_Criteria_Percentage_Id" SortExpression="Evaluation_Criteria_Percentage_Id" 
                                                    HeaderText="Evaluation_Criteria_Percentage_Id">
                                                ...
                                                <asp:BoundField DataField="Percentage" SortExpression="Percentage" 
                                                    HeaderText="Percentage">
                                                    <HeaderStyle HorizontalAlign="Left" Width="25%" />
                                                    <ItemStyle HorizontalAlign="Left" Width="25%" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="Evaluation_Criteria_Type_Id" 
                                                    HeaderText="Evaluation_Criteria_Type_Id" Visible="False">
                                                </asp:BoundField>
                                                ...
                                                <asp:TemplateField HeaderText="Edit">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="btnEdit" runat="server" 
                                                            CommandArgument='<%# Eval("Evaluation_Criteria_Percentage_Id") %>' ForeColor="#004999" 
                                                ...
                                                <asp:TemplateField HeaderText="Copy">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="btnCopy" runat="server" ForeColor="#004999" OnClick="btnCopy_Click"
                                                            ...
                                                            CommandArgument='<%# Eval("Evaluation_Criteria_Percentage_Id") %>'></asp:ImageButton>
                                                    </ItemTemplate>
...
<HeaderStyle CssClass="hide" />
                                ...
                                <tr id="trSave" runat="server" style="width: 100%">
                                    <td style="height: 19px; text-align: center" align="right" colspan="2">
                                        <asp:Button ID="btn_apply" runat="server" CssClass="btn btn-primary" 
                                            OnClick="btn_apply_Click" Text="Apply All Changes" />
                                    </td>
                                </tr>
                            </table>
                        </td>
