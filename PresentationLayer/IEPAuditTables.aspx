<%@ Page Title="" Language="C#" MasterPageFile="~/PresentationLayer/MasterPage.master"
    AutoEventWireup="true" CodeFile="IEPAuditTables.aspx.cs" Inherits="PresentationLayer_IEPAuditTables" %>
                            ...
                            <table class="main_table" cellspacing="0" cellpadding="0" width="100%" align="center"
                                ...
                                <tr style="width: 100%">
                                 ...
                                 <tr style="width: 100%">
                                        ...
                                        <div style="overflow-x:auto;width:1200px">
                                         ...
                                         <asp:GridView ID="dv_IepRaisec" runat="server" AllowPaging="True" AllowSorting="True"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="Updated_By" HeaderText="Updated_By"></asp:BoundField>
                                                <asp:BoundField DataField="Updated_date" HeaderText="Updated_date"></asp:BoundField>
                                  ...
                                  <td style="width: 100%">
                                        &nbsp;
                                      <h3>Counselor Recommendations AUDIT</h3>
                                 ...
                                 <tr style="width: 100%">
                                  <td style="width: 100%">
                                        &nbsp;
                                      <h3> Extra-Curricular Activities AUDIT</h3>
                                        <div style="overflow-x:auto;width:1200px">
