<%@ Page Language="C#" AutoEventWireup="true" CodeFile="New_Bifurcation_Confirmation.aspx.cs" Inherits="PresentationLayer_New_Bifurcation_Confirmation" %>
...
<body >
    <form runat="server">
        ...
        <h1 class="text-center thanku">Thank you for Your Confirmation</h1>
<%--                 <img src="Component_Marks/ReportCard/images/check.png" />--%>
                	<i class="fa fa-check main-content__checkmark tick" id="checkmark"></i>
