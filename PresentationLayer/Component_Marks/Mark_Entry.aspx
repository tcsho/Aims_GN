<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Mark_Entry.aspx.cs" Inherits="PresentationLayer_Component_Marks_Mark_Entry" %>
...
<body>
    ...
    <div class="container body-content">
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12" style="box-shadow: 0px 2px 4px -1px #00006a;padding: 7px 40px 40px 40px;">
                ...
                <form class="form-horizontal product-setup-form marks_form custom-form" autocomplete="off">
                    ...
                    <!--tab---->
                    <!-- Nav tabs -->
                    <!--<ul class="nav nav-tabs yarntabs" role="tablist">
        <li role="presentation" class="tabsli">
            <a href="#SeatPlan" aria-controls="home" role="tab" data-toggle="tab" aria-expanded="true">Seat Plan</a>
        </li>
        <li role="presentation" class="tabsli">
            <a href="#Normal" aria-controls="home" role="tab" data-toggle="tab" aria-expanded="false">Normal</a>
        </li>
    </ul>-->
                    <!--<ul class="nav nav-pills">
        <li class="active">
            <a href="#SeatPlan" data-toggle="tab">SeatPlan</a>
        </li>
        <li>
        ...
        <li class="nav-item">
            <a class="nav-link active" href="#SeatPlan" role="tab" data-toggle="tab">SeatPlan</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="#Normal" role="tab" data-toggle="tab">Normal</a>
        </li>
                    ...
                    <div class="tab-wrapper">
                        <ul class="tabs">
                            <li class="tab-link active" data-tab="1">SeatPlan</li>
                            <li class="tab-link" data-tab="2">Normal</li>
                        ...
                        <div id="tab-1" class="tab-content active">
                            ...
                            <div [formGroup]="unitGroup">
                                <div class="row">
                                    ...
                                    <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
                                        <span class="CustomLabel">Mode</span><br>
                                        <select class="Mode_list form-control">

                                            <option value="1">Seat Plan</option>
                                            <option value="2">Normal</option>

                                        </select>
                                    </div>
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 normalhide">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <button class="fetch btn btn-primary savebtn normalhide" type="button">Show</button>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 boxpadding nopadding normalhide">
                            ...
                            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 nopadding normalhide">
                        ...
                        <div id="tab-2" class="tab-content">
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                    <span class="CustomLabel">Class Section</span> <span class="RequiredLbl"> * </span><br>

                                    <select class="NormalClassSectionList form-control">
                                        <option value="">---Select---</option>
                                    </select>
                                    <p class="error-message">* Class Section Required</p>

                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                    <span class="CustomLabel">Subject</span> <span class="RequiredLbl"> * </span><br>

                                    <select class="NormalSubjectList form-control">
                                        <option value="">---Select---</option>
                                    </select>
                                    <p class="error-message">* Subjec Required</p>

                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                    <span class="CustomLabel">Student</span> <span class="RequiredLbl"> * </span><br>

                                    <select class="NormalStudentList form-control">
                                        <option value="">---Select---</option>
                                    </select>
                                    <p class="error-message">* Student Required</p>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                    ...
                                    <select class="NormalTermList form-control">
                                        <option value="">---Select---</option>
                                    </select>
                                    <p class="error-message">* Term Required</p>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                    <span class="CustomLabel">Evaluation Type</span> <span class="RequiredLbl"> * </span><br>

                                    <select class="NormalEvaluationTypeList form-control">
                                        <option value="">---Select---</option>
                                    </select>
                                    <p class="error-message">* Evaluation Type Required</p>

                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                    <span class="CustomLabel">Evaluation Criteria</span> <span class="RequiredLbl"> * </span><br>

                                    <select class="NormalEvaluationCriteriaList form-control">
                                        <option value="">---Select---</option>
                                    </select>
                                    <p class="error-message">* Evaluation Criteria Required</p>

                                </div>

                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">

                                    <button class="fetch_mode btn btn-primary savebtn normalshow" type="button">Show Normal</button>
                                    <button class="test btn btn-primary savebtn" type="button" id="test">Test</button>
                                    
                                </div>

                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 normaltable normalshow">
                                    <table class="table table-bordered">
                                        <thead>
                                            <tr>
                                                <th class="visibilityhidden">Hidden</th>
                                                <th>No</th>
                                                <th>Name</th>
                                                <th>Roll No</th>
                                                <th>
        ...
        <div class="tab-pane active" id="SeatPlan">
        ...
        <script>
            ...
            var UserId = 29158;// GetUrlParameter('UserID');
            var cenid = 2010201; //GetUrlParameter('Center_ID');
            var Org_Id = 1;//GetUrlParameter('Org_Id');
            //alert(UserId + "--" + cenid);
            var updateflag = 0;
            //var UrlRoute = {
            ...
            /**MODE CHANGE ***/
            //$(".Mode_list").change(function () {
            //    var Modes = $(this).val();
            //    if (Modes == 1) {
            //        $(".normalshow").hide("slow");
            //        $(".normalhide").show("slow");
            //    }
            //    else {
            //        $(".normalshow").show("slow");
            //        $(".normalhide").hide("slow");
            //    }
            //});
            /***MODE CHANGE ***/
            ...
            /***NORMAL VALIDATION**/
            var NormalClassSectionListvalidation;
            var NormalSubjectListvalidation;
              var NormalStudentListvalidation;
                var NormalTermListvalidation;
                var NormalEvaluationTypeListvalidation;
            var NormalEvaluationCriteriaListvalidation;

            function normalvalidation() { 
               NormalClassSectionListvalidation = $('.NormalClassSectionList').val();
               NormalSubjectListvalidation = $('.NormalSubjectList').val();
                NormalStudentListvalidation = $('.NormalStudentList').val();
                NormalTermListvalidation = $('.NormalTermList').val();
                NormalEvaluationTypeListvalidation = $('.NormalEvaluationTypeList').val();
            var NormalEvaluationCriteriaListvalidation = $(".NormalEvaluationCriteriaList").val();

                $('.NormalClassSectionList').change("select", function () {
                    $('.NormalClassSectionList').next(".error-message").hide();
                    $('.NormalClassSectionList').css('border', 'none');
                    $('.NormalClassSectionList').css('background', '#d8f9d8');
                });
                if (NormalClassSectionListvalidation == null || NormalClassSectionListvalidation == undefined || NormalClassSectionListvalidation == "" || NormalClassSectionListvalidation == " ") {
                    $('.NormalClassSectionList').next(".error-message").text("* Class Section Required");
                    $('.NormalClassSectionList').next(".error-message").show();
                    $('.NormalClassSectionList').css('border', '1px solid red');
                    $('.NormalClassSectionList').css('background', '#fff');
                    $('.NormalClassSectionList').focus();
                    return false;
            }

               $('.NormalSubjectList').change("select", function () {
                    $('.NormalSubjectList').next(".error-message").hide();
                    $('.NormalSubjectList').css('border', 'none');
                    $('.NormalSubjectList').css('background', '#d8f9d8');
                });
                if (NormalSubjectListvalidation == null || NormalSubjectListvalidation == undefined || NormalSubjectListvalidation == "" || NormalSubjectListvalidation == " ") {
                    $('.NormalSubjectList').next(".error-message").text("* Subject Required");
                    $('.NormalSubjectList').next(".error-message").show();
                    $('.NormalSubjectList').css('border', '1px solid red');
                    $('.NormalSubjectList').css('background', '#fff');
                    $('.NormalSubjectList').focus();
                    return false;
            }

             $('.NormalTermList').change("select", function () {
                    $('.NormalTermList').next(".error-message").hide();
                    $('.NormalTermList').css('border', 'none');
                    $('.NormalTermList').css('background', '#d8f9d8');
                });
                if (NormalTermListvalidation == null || NormalTermListvalidation == undefined || NormalTermListvalidation == "" || NormalTermListvalidation == " ") {
                    $('.NormalTermList').next(".error-message").text("* Term Required");
                    $('.NormalTermList').next(".error-message").show();
                    $('.NormalTermList').css('border', '1px solid red');
                    $('.NormalTermList').css('background', '#fff');
                    $('.NormalTermList').focus();
                    return false;
            }
            $('.NormalEvaluationTypeList').change("select", function () {
                    $('.NormalEvaluationTypeList').next(".error-message").hide();
                    $('.NormalEvaluationTypeList').css('border', 'none');
                    $('.NormalEvaluationTypeList').css('background', '#d8f9d8');
                });
                if (NormalEvaluationTypeListvalidation == null || NormalEvaluationTypeListvalidation == undefined || NormalEvaluationTypeListvalidation == "" || NormalEvaluationTypeListvalidation == " ") {
                    $('.NormalEvaluationTypeList').next(".error-message").text("* Evaluation Type Required");
                    $('.NormalEvaluationTypeList').next(".error-message").show();
                    $('.NormalEvaluationTypeList').css('border', '1px solid red');
                    $('.NormalEvaluationTypeList').css('background', '#fff');
                    $('.NormalEvaluationTypeList').focus();
                    return false;
            }

              $('.NormalEvaluationCriteriaList').change("select", function () {
                    $('.NormalEvaluationCriteriaList').next(".error-message").hide();
                    $('.NormalEvaluationCriteriaList').css('border', 'none');
                    $('.NormalEvaluationCriteriaList').css('background', '#d8f9d8');
                });
                if (NormalEvaluationCriteriaListvalidation == null || NormalEvaluationCriteriaListvalidation == undefined || NormalEvaluationCriteriaListvalidation == "" || NormalEvaluationCriteriaListvalidation == " ") {
                    $('.NormalEvaluationCriteriaList').next(".error-message").text("* Evaluation Criteria Required");
                    $('.NormalEvaluationCriteriaList').next(".error-message").show();
                    $('.NormalEvaluationCriteriaList').css('border', '1px solid red');
                    $('.NormalEvaluationCriteriaList').css('background', '#fff');
                    $('.NormalEvaluationCriteriaList').focus();
                    return false;
                }
                }
            /**NORMAL VALIDATION***/
            ...
            $(".fetch_mode").click(function () {
               
                if (normalvalidation() == false) {
                    $(".overlay").hide();
                    return;
                     ...
                     $(".overlay").show();
                //alert($(".NormalStudentList option").length);
                //exit();
                ...
                //int Evaluation_Type_Id =  Convert.ToInt32(list_EvlType.SelectedValue.ToString());
                //int Evaluation_Criteria_Id = Convert.ToInt32(list_EvlCriteria.SelectedValue.ToString());
 

                /**ADD MISSING STUDENT**/
                     var AlreadyIn = 0;
                    $(".NormalStudentList option").each(function () {

                        //Student_Evaluation_CriteriaInsertMissingStudent(long StudentId, long Section_Id, long AlreadyIn)
                        var NormalClassSectionId = parseInt($(".NormalClassSectionList").val());
                        var NormalTermId = $(".NormalTermList").val();
                        var NormalSectionSubjectId = $(".NormalSubjectList").val();
                        var NormalStudentId = parseInt($(this).val());
                        var NormalEvaluationTypeId = $(".NormalEvaluationTypeList").val();
                        var NormalEvaluationCriteriaId = $(".NormalEvaluationCriteriaList").val();
                       
                        if (NormalStudentId != 0) {
                            $.ajax({
                                
                                async: false,
                               // data: { StudentId: NormalStudentId, Section_Id: NormalClassSectionId, AlreadyIn: AlreadyIn },
                                //dataType: 'json',
                                //url: 'http://localhost:52673/api/Setup/Student_Evaluation_CriteriaInsertMissingStudent',
                                 url: 'http://localhost:52673/api/Setup/Student_Evaluation_CriteriaInsertMissingStudent?StudentId='+NormalStudentId+'&Section_Id='+NormalClassSectionId+'&AlreadyIn='+AlreadyIn,
                                type: 'POST',
                                success: function (result) {
                                    AlreadyIn = 1;
                                },
                                error: function (err) {
                                    AlreadyIn = 0;
                                    console.log("Add missing data" + JSON.stringify(err))
                ...
                /**ADD MISSING STUDENT**/
                      var NormalClassSectionId = $(".NormalClassSectionList").val();
                    var NormalTermId = $(".NormalTermList").val();
                        var NormalSectionSubjectId = $(".NormalSubjectList").val();
                        var NormalStudentId = $(".NormalStudentList").val();
                        var NormalEvaluationTypeId = $(".NormalEvaluationTypeList").val();
                    var NormalEvaluationCriteriaId = $(".NormalEvaluationCriteriaList").val();
                /**GET SSEC_Id */
                    ...
                    $.ajax({
                        type: 'GET',
                        async: false,
                        data: { ClassSection_Id: NormalClassSectionId, Section_Subject_Id: NormalSectionSubjectId, TermGroup_Id: NormalTermId, Evaluation_Type_Id: NormalEvaluationTypeId},//, Evaluation_Criteria_Id: NormalEvaluationCriteriaId 
                        url: 'http://localhost:52673/api/Setup/CheckSSECID',

                        success: function (result) {
                            //console.log("SSEC_ID" + JSON.stringify(result));
                            SSECID=result[0].SSEC_Id;
                        }
                    });
                /**GET SSEC_Id */
                    $(".normaltable tbody").html("");
                var normaltable = "";
                
                var srno = 0;
                    //if ($(".NormalStudentList").val() == "" || $(".NormalStudentList").val() == null) {
                    //  $(".NormalStudentList option").each(function () {
                    ...
                    //            type: 'GET',
                    //            async: false,
                    //            data: { Evaluation_Criteria_Type_Id: NormalTermId, Section_Subject_Id: NormalSectionSubjectId, Student_id: NormalStudentId, Evaluation_Type_Id: NormalEvaluationTypeId, Evaluation_Criteria_Id: NormalEvaluationCriteriaId },
                    //            url: 'http://localhost:52673/api/Setup/Student_Evaluation_CriteriaEVlCriteriaBySectSubjIdNew',

                    //            success: function (result) {
                    //                console.log("reusltsyyu" + JSON.stringify(result));
                    //                srno = srno + 1;
                    //                if (result == null || result == "" || result == " ") {
                    //                    Swal.fire(
                    //                        'No Data',
                    ...
                    //                        normaltable += '<tr>';
                    //                        normaltable += '<td class="visibilityhidden"><span class="normal_RollNo">' + result[tt].RollNo + '</span><span class="normal_stusecsubid">' + result[tt].Student_Section_Subject_Id + '</span>';
                    //                        //normaltable += '<span class="normal_section_subject_id">' + result[tt].Section_Subject_Id + '</span><span class="normal_student_section_subject_id">' + result[tt].Student_Section_Subject_Id + '</span></span><span class="normal_sess_id">' + result[tt].Session_Id + '</span>';
                    //                        normaltable += '</td>';
                    //                        normaltable += '<td class="normal_studentname">' + srno + '</td>';
                    //                        normaltable += '<td class="normal_teachername">' + result[tt].Name + '</td>';
                    //                        normaltable += '<td class="normal_subjectname">' + result[tt].RollNo + '</td>';
                    //                        if (result[tt].DDD == null) {

                    //                            normaltable += '<td class="normal_markbox"><input type="text" class="form-control normaltotalmarks" placeholder="Enter Marks"  onchange="normalstudent_totalmarks(this)" onkeydown="normalstudent_totalmarks(this)" onkeyup="normalstudent_totalmarks(this)" /><p class="error-message">* Total Mark Required</p></td>';//onchange="normalstudent_totalmarks(this)" onkeydown="normalstudent_totalmarks(this)" onkeyup="normalstudent_totalmarks(this)" <p class="error-message">* Total Mark Required</p>
                    //                        }
                    //                        else {
                    //                            normaltable += '<td class="normal_markbox">' + result[tt].DDD + '</td>';
                    //                        }

                    //                        //normaltable += '<td><input type="text" class="form-control normaltotalmarks" placeholder="Enter Marks" onchange="normalstudent_totalmarks(this)" onkeydown="normalstudent_totalmarks(this)" onkeyup="normalstudent_totalmarks(this)"/><p class="error-message">* Total Mark Required</p></td>';
                    //                        normaltable += '<td><button type="button" class="savenormal_student btn btn-primary" onClick="SaveNormalStudent(this)">Save</button></td>';
                    //                        normaltable += '</tr>';
                    ...
                    //else {
                        ...
                        $.ajax({
                            ...
                            success: function (result) {
                                console.log("1resrilu" + JSON.stringify(result));
                                srno = srno + 1;
                                if (result == null || result == "" || result == " ") {
                                    Swal.fire(
                                        'No Data',
                                    ...
                                    $(".normaltable tbody").html(normaltable);
                                }
                            },
                            complete: function (result) {
            ...
            function SaveNormalStudent(items) {
                var $normalrow = $(items).closest("tr");
               
               // var normal_Main_Organisation_Id = 1;
               // var normal_Evaluation_Criteria_Id = $(".NormalEvaluationCriteriaList").val();
               //  var normal_Section_Subject_Id = $(".NormalSubjectList").val();
               // var normal_Criteria = $(".NormalEvaluationCriteriaList option:selected").text();
               
               // var normal_Total_Marks = $normalrow.find(".normaltotalmarks").val();
               // var normal_Evaluation_Criteria_Type_Id=$(".NormalTermList").val();
               //var normal_Evaluation_Type_Id = $(".NormalEvaluationTypeList").val();


                

                //var normal_studentid = $normalrow.find(".normal_studentid").text();
                //var normal_sess_id= $normalrow.find(".normal_sess_id").text();
                //var normal_empid = $normalrow.find(".normal_empid").text();
                //var normal_subid = $normalrow.find(".normal_subid").text();

                //var normal_section_subject_id = $normalrow.find(".normal_stusecsubid").text();
                var normal_student_section_subject_id= $normalrow.find(".normal_stusecsubid").text();
                 var normal_Total_Marks = $normalrow.find(".normaltotalmarks").val();

                //var normal_teachername = $normalrow.find(".normal_teachername").text();
                //var normal_studentname = $normalrow.find(".normal_studentname").text();
                //var normal_subjectname = $normalrow.find(".normal_subjectname").text();



                //console.log("Normal Entry" + normaltotalmarks + "Teacher name" + normal_teachername + "Student name" + normal_studentname + "Subject name" + normal_subjectname);

                //console.log("normal_studentid" + normal_studentid + "normal_empid" + normal_empid + "normal_subid" + normal_subid);


                var normaltotalmarksclass = $normalrow.find(".normaltotalmarks");

                if (normal_Total_Marks == null || normal_Total_Marks == "" || normal_Total_Marks == " ") {
                    $(normaltotalmarksclass).next(".error-message").text("* Total Mark Required");
                    $(normaltotalmarksclass).next(".error-message").show();
                    $(normaltotalmarksclass).css('border', '1px solid red');
                    $(normaltotalmarksclass).css('background', '#fff');
                    $(normaltotalmarksclass).focus();
                    return;
                }
                else {
                /**CHECK SSEID ****/
                    $.ajax({
                        type: 'GET',
                        async: false,
                        data: { SSEC_Id: SSECID, Student_Section_Subject_Id: normal_student_section_subject_id},
                        url: 'http://localhost:52673/api/Setup/MarkNormalCheckCriteria',
                        success: function (result)
                        {
                            
                                if (result == "" || result == null)
                                {
                                    var dataaddnormal = JSON.stringify({
                                        SSEC_Id:SSECID,
                                        Student_Section_Subject_Id: normal_student_section_subject_id,
                                        Marks_Obtained: normal_Total_Marks,
                                        //Lock_Mark: 0,
                                        //Status_Id: 1,
                                        BackUpMarks: normal_Total_Marks
                                    });

                                      $.when(savenormalOrder(dataaddnormal)).then(function (response) {
                                            //console.log("RESPONSESSS" + response);
                                        }).fail(function (err) {
                                            //alert("already exitss" + err);
                                        });
                                }
                                else
                                {
                                    ...
                                    $.ajax({
                                        type: 'GET',
                                        async: false,
                                        data: {Marks_Obtained:normal_Total_Marks,BackUpMarks:normal_Total_Marks,SSEC_Id:SSECID, Student_Section_Subject_Id: normal_student_section_subject_id },
                                        url: 'http://localhost:52673/api/Setup/MarkNormalUpdateCriteria',
                                        success: function (result)
                                        {
                                            Swal.fire(
                                                'Update Successfuly!',
            ...
            function normalstudent_totalmarks(itemi) {
                //var total_mark_Papers = $(".total_mark_Paper").text();
                if ($(itemi).val() > 100)
                //&& e.keyCode !== 46
                //&& e.keyCode !== 8
                {
                    //preventDefault();
                    $(itemi).val("");
                    $(itemi).next(".error-message").text("* Mark Excessed");
                    $(itemi).next(".error-message").show();
                    $(itemi).css('border', '1px solid red');
                    $(itemi).css('background', '#fff');
                    $(itemi).focus();
                    return;
                }

                else {
                    $(itemi).next(".error-message").hide();
                    $(itemi).css('border', 'none');
                    $(itemi).css('background', '#d8f9d8');
                }
            }


            function savenormalOrder(dataaddnormal) {
                        console.table("dataaddnormal" + dataaddnormal);
                        ...
                        return $.ajax({
                            ...
                            //url: 'http://localhost:52673/api/Setup/MarkNormalSave',
                            url: 'http://localhost:52673/api/Setup/MarkNormalSaveCriteria',
                            success: function (result) {
                                //alert("save");
                                Swal.fire(
                                    'Save Successfuly!',
            ...
            $.ajax({
                ...
                success: function (result) {
                    NormalClassSectionList += '<option selected="true" disabled="disabled" value="">---Select---</option>';

                    for (var i = 0; i < result.length; i++) {


                        NormalClassSectionList += '<option value="' + result[i].Section_Id + '">' + result[i].FullClassSection + '</option>';


                    }
                    $(".NormalClassSectionList").html(NormalClassSectionList);
            ...
            $(".NormalClassSectionList").change(function () {
                var NormalSectionId=$(this).val();
                var NormalSubjectList = "";
                $.ajax({
                    type: 'GET',
                    data: { Employee_Id: UserId, Section_Id:NormalSectionId },
                    url: 'http://localhost:52673/api/Setup/SectionSubjectSelectByEvaluationCriteria',//sURLVariableswithurl[0]+"?",//getsearchedpatient
                    success: function (result) {
                        NormalSubjectList += '<option selected="true" disabled="disabled" value="">---Select---</option>';

                        for (var i = 0; i < result.length; i++) {


                            NormalSubjectList += '<option value="' + result[i].Section_Subject_Id + '">' + result[i].Subject_Name + '</option>';


                        }
                        $(".NormalSubjectList").html(NormalSubjectList);
                ...
                $.ajax({
                    type: 'GET',
                    data: { Org_Id: Org_Id, Section_Id:NormalSectionId },
                    url: 'http://localhost:52673/api/Setup/Evaluation_Criteria_TypeBySectionId',
                    success: function (result) {
                        NormalTermList += '<option selected="true" disabled="disabled" value="">---Select---</option>';

                        for (var i = 0; i < result.length; i++) {


                            NormalTermList += '<option value="' + result[i].Id + '">' + result[i].Type + '</option>';


                        }
                        $(".NormalTermList").html(NormalTermList);
                ...
                var NormalEvaluationTypeList = "";
                $.ajax({
                    type: 'GET',
                    data: { Org_Id: Org_Id },
                    url: 'http://localhost:52673/api/Setup/Evaluation_TypeSelect',
                    success: function (result) {
                        NormalEvaluationTypeList += '<option selected="true" disabled="disabled" value="">---Select---</option>';

                        for (var i = 0; i < result.length; i++) {
                            
				

                           NormalEvaluationTypeList += '<option value="' + result[i].Evaluation_Type_Id + '">' + result[i].Name + '</option>';


                        }
                        $(".NormalEvaluationTypeList").html(NormalEvaluationTypeList);
            ...
            $(".NormalSubjectList").change(function () {
                var NormalSectionSubjectId=$(this).val();
                var NormalStudentList = "";
                $.ajax({
                    type: 'GET',
                    data: { Section_Subject_Id:NormalSectionSubjectId  },
                    url: 'http://localhost:52673/api/Setup/StudentBySectionSubjectId',
                    success: function (result) {
                        NormalStudentList += '<option selected="true"  value="0">---Select---</option>';

                        for (var i = 0; i < result.length; i++) {



                            NormalStudentList += '<option value="' + result[i].Student_Id + '">' + result[i].FullStudentName + '</option>';


                        }
                        $(".NormalStudentList").html(NormalStudentList);
            ...
            $(".NormalEvaluationTypeList").change(function () {
                
                var NormalEvaluationTypeId = $(this).val();
                var NormalTermId = $(".NormalTermList").val();
                var NormalSubjectId = $(".NormalSubjectList").val();
                var NormalEvaluationCriteriaList = "";
                $.ajax({
                    type: 'GET',
                    data: { Evaluation_Criteria_Type_Id:NormalTermId,Section_Subject_Id:NormalSubjectId,Evaluation_Type_Id:NormalEvaluationTypeId},
                    url: 'http://localhost:52673/api/Setup/Evaluation_Criteria_BySectionIdSubjectEvlId',
                    success: function (result) {
                        NormalEvaluationCriteriaList += '<option selected="true" disabled="disabled" value="">---Select---</option>';

                        for (var i = 0; i < result.length; i++) {
                            NormalEvaluationCriteriaList += '<option value="' + result[i].Evaluation_Criteria_Id + '">' + result[i].Criteria + '</option>';
                        }
                        $(".NormalEvaluationCriteriaList").html(NormalEvaluationCriteriaList);
            ...
            $("#test").click(function () {
                $.ajax({
                    type: "POST",
                    url: "Mark_Entry.aspx/doSomething",
                    //data: "{'EvaluationCriteriaTypeId':'16'}",
                    //data: { EvaluationCriteriaTypeId:16, SectionSubjectId:368259, Studentid:0, EvaluationTypeId:2, EvaluationCriteriaId:2423 },
                    //data: "{'EvaluationCriteriaTypeId':'16','SectionSubjectId','368259'}",//,'Studentid'.'0','EvaluationTypeId','2','EvaluationCriteriaId','2423'
                    data: JSON.stringify({ EvaluationCriteriaTypeId: 16, SectionSubjectId: 368259, Studentid: 0, EvaluationTypeId: 2, EvaluationCriteriaId:2423 }),
                    dataType: "json",
                    contentType: "application/json; charset=utf-8",
                    success: function (data) {

                        var jsondata = JSON.parse(data.d);
                        //var end ="EndofYearExam=50=1744610"
