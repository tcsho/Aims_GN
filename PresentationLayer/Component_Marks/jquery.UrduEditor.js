...
(function ($) {
    var urduBtn = $('<img class="urdubtns"/>').attr('src', 'urdubtn.gif');
    var englishBtn = $('<img class="engbtns"/>').attr('src', 'engbtn.gif');//scriptPath
    var vkBtn = $('<img  class="keyboardbtns"/>').attr('src', 'keyboard.gif');
    ...
    var SrcElement;
    var Settings = {
        EditorFont:"inherit",//"Urdu Naskh Asiatype",
        EnglishColor: "#CCCCFF",
        UrduColor: "#99FF99",
		PointSize:"14px",
		ToggleControls:true,
...
codes[String.fromCharCode(0x0651)] = 'تشدید';
   ...
   //         var urduBtn = $('<img />').attr('src','urdubtn.gif');
			//var englishBtn = $('<img />').attr('src', scriptPath + '/engbtn.gif');
			//var vkBtn = $('<img />').attr('src','keyboard.gif');
            var lineBreak = $('<br style="display:none"/>');//
