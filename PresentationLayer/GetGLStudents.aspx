<%@ Page Title="" Language="C#" MasterPageFile="~/PresentationLayer/MasterPage.master"
    AutoEventWireup="true" CodeFile="GetGLStudents.aspx.cs" Inherits="PresentationLayer_GetGLStudents"
    Theme="BlueTheme" %>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td id="tdFrmHeading" class="formheading">
                                            <asp:Label ID="Label1" CssClass="lblFormHead" runat="server" Text="Select GL Students"></asp:Label>
                            ...
                            <table cellspacing="1" cellpadding="1" width="100%" bgcolor="#ffffff" border="0">
                                <tbody>
                                    ...
                                    <tr id="trRegion" runat="server">
                                        ...
                                        <td valign="top">
                                            <asp:DropDownList ID="ddl_region" runat="server" CssClass="dropdownlist" Width="250px" AutoPostBack="True" OnSelectedIndexChanged="ddl_Region_SelectedIndexChanged">
                                            </asp:DropDownList>
                                    ...
                                    <tr class="tr2">
                                        ...
                                        <td valign="top" style="padding: 12px; padding-left: 4.6%;">
