...
public partial class PresentationLayer_PerformanceEvaluationLabels : System.Web.UI.Page
{
    ...
    private void BindGrid()
    {
        ...
        {
            dtsub = (DataTable)objClsSec.Student_Performance_SubClassActLbl_SelectAllByOrgIdClassIdSubjectId(objClsSec);
        }
        else
        {
    ...
    protected void btnEdit_Click(object sender, EventArgs e)
    {
        ...
        dtsub = (DataTable)objClsSec.Student_Performance_SubClassActLbl_SelectAllBySubKndItmLblId(objClsSec);

        txtCritName.Text = dtsub.Rows[0]["Description"].ToString().Trim();
        txtSortOrder.Text = dtsub.Rows[0]["OrderOfPer"].ToString().Trim();
    ...
    protected void but_save_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            objClsSec.OrderOfPer = Convert.ToInt32(txtSortOrder.Text);
            ...
            if (mode != "Edit")
            {
                ...
                AlreadyIn = objClsSec.Student_Performance_SubClassActLblAdd(objClsSec);
            ...
            else
            {
                ...
                AlreadyIn = objClsSec.Student_Performance_SubClassActLblUpdate(objClsSec);
